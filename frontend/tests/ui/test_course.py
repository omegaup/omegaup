...
def test_create_course(driver):
    ...
    with driver.login_admin():
        ...
        driver.browser.find_element_by_xpath(
            '//a[contains(@href, "/course/new/")]').click()

        driver.browser.find_element_by_class_name('name').send_keys(
            course_alias)
        ...
        driver.browser.find_element_by_xpath(
            '//a[contains(@href, "students")]').click()
        ...
        driver.browser.find_element_by_css_selector(
            '#assignments .new button').click()

        driver.browser.find_element_by_css_selector(
            '.schedule .name').send_keys(assignment_alias)
        driver.browser.find_element_by_css_selector(
        ...
        driver.browser.find_element_by_xpath(
            '//a[contains(@href, "problems")]').click()
