...
class AssignmentProblemsTest extends \OmegaUp\Test\ControllerTestCase {
    ...
    public function testAssignmentProblemsStatistics() {
        ...
        // Percent over 60%
        $this->assertEquals(0.5, $results[0]['high_score_percentage']);
        $this->assertEquals(1, $results[1]['high_score_percentage']);
        $this->assertEquals(0, $results[2]['high_score_percentage']);
        // Percent at 0%
        $this->assertEquals(0.5, $results[0]['low_score_percentage']);
        $this->assertEquals(0, $results[1]['low_score_percentage']);
        $this->assertEquals(1, $results[2]['low_score_percentage']);
    }
}
