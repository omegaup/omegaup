...
class ContestListTest extends OmegaupTestCase {
    ...
    public function testShowOnlyCurrentContests() {
        ...
        $currentContestData = ContestsFactory::createContest(new ContestParams(['modality' => 'private']));
    ...
    public function testPrivateContestListForInvitedUser() {
        ...
        for ($i = 0; $i < 4; $i++) {
            ...
            $contestData[$i] = ContestsFactory::createContest(new ContestParams(['modality' => $isPublic]));
        }
