...
/**
 * Simple test for introToAlgorithms2CourseGraduate user Badge
 *
 * @author RodCross
 */
...
class Badge_introToAlgorithms2CourseGraduateTest extends \OmegaUp\Test\BadgesTestCase {
    ...
    public function setUp(): void {
        parent::setUp();
        $courseAlias = 'introduccion_a_algoritmos_ii';
    ...
    public function testIntroToAlgorithms2CourseEarnBadge() {
        ...
        $queryPath = static::OMEGAUP_BADGES_ROOT . '/introToAlgorithms2CourseGraduate/' . static::QUERY_FILE;
        $results = self::getSortedResults(file_get_contents($queryPath));
        $expected = [$this->students[0]['user']->user_id];
        $this->assertEquals($expected, $results);
    }

    public function testIntroToAlgorithms2CourseDoNotEarnBadge() {
