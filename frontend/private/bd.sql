...
CREATE TABLE IF NOT EXISTS `Clarifications` (
  ...
  `public` tinyint(1) DEFAULT '0' COMMENT 'SÃ³lo las clarificaciones que el problemsetter marque como publicacbles apareceran en la lista que toda la banda puede ver. Sino, solo al usuario. ',
