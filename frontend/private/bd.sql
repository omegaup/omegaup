...
--
-- Servidor: localhost
-- Tiempo de generación: 30-03-2011 a las 23:20:09
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Esta tabla guarda la informacion de cada uno de los badges.' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `Contests` (
  ...
  `penality` int(11) NOT NULL DEFAULT '1' COMMENT 'Entero indicando el número de minutos con que se penaliza por recibir un no-accepted',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Establece los permisos que se pueden dar a los roles.' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `Problems_Badges` (
  ...
  KEY `problem_id` (`problem_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Relación entre 1 badge y los problemas que lo desbloqueaan.';
...
CREATE TABLE IF NOT EXISTS `Roles` (
  ...
  PRIMARY KEY (`role_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Establece los roles que se pueden dar a los usuarios.' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Establece los roles que se pueden dar a los usuarios.';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Guarda los badges que han sido desbloqueados.';
...
ALTER TABLE `Clarifications`
  ADD CONSTRAINT `fk_c_problem_id` FOREIGN KEY (`problem_id`) REFERENCES `problems` (`problem_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_c_contest_id` FOREIGN KEY (`contest_id`) REFERENCES `contests` (`contest_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_c_author_id` FOREIGN KEY (`author_id`) REFERENCES `users` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `Coder_of_the_Month`
--
ALTER TABLE `Coder_of_the_Month`
  ADD CONSTRAINT `coder_of_the_month_id` FOREIGN KEY (`coder_of_the_month_id`) REFERENCES `users` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `Contests`
--
ALTER TABLE `Contests`
  ADD CONSTRAINT `director_id` FOREIGN KEY (`director_id`) REFERENCES `users` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `rerun_id` FOREIGN KEY (`contest_id`) REFERENCES `contests` (`contest_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `Contests_Users`
--
ALTER TABLE `Contests_Users`
  ADD CONSTRAINT `fk_cu_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_cu_contest_id` FOREIGN KEY (`contest_id`) REFERENCES `contests` (`contest_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `Contest_Problems`
--
ALTER TABLE `Contest_Problems`
  ADD CONSTRAINT `contest_id` FOREIGN KEY (`contest_id`) REFERENCES `contests` (`contest_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `problem_id` FOREIGN KEY (`problem_id`) REFERENCES `problems` (`problem_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
