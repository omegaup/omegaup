...
const translations: { [key: string]: string; } = {
  ...
  problemCreatorAllGroupCasesWillBeDeleted: "Todos os casos deste grupo ser\u00e3o deletados",
  problemCreatorAutoPoints: "Pontos Autom\u00e1ticos",
  problemCreatorCancel: "Cancelar",
  problemCreatorCantUndo: "Essa a\u00e7\u00e3o n\u00e3o pode ser desfeita",
  problemCreatorCase: "Caso",
  problemCreatorCaseName: "Nome do caso",
  problemCreatorCaseNameHint: "Letras min\u00fasculas e sem espa\u00e7os em branco",
  problemCreatorCaseNumber: "N\u00famero de casos",
  problemCreatorCaseNumberHint: "The testcases will have the name of ",
  problemCreatorCases: "Casos de teste",
  problemCreatorCreateProblem: "Gerar problema",
  problemCreatorDelete: "Excluir",
  problemCreatorDeleteAllCases: "Apagar todos os casos",
  problemCreatorDeleteGroup: "Excluir Grupo",
  problemCreatorDeleteGroupCasesConfirmation: "Tem certeza de que deseja excluir todos os casos de teste deste grupo?",
  problemCreatorDeleteGroupConfirmation: "Tem certeza de que deseja excluir este grupo?",
  problemCreatorEdit: "Editar",
  problemCreatorEditGroup: "Editar Grupo",
  ...
  problemCreatorMulticase: "Casos M\u00faltiplos",
  problemCreatorName: "Nome",
  problemCreatorNamePlaceholder: "Novo Problema",
  problemCreatorNewProblem: "Novo Problema",
  problemCreatorNoGroup: "nenhum_grupo",
  problemCreatorPoints: "Pontos",
  problemCreatorPointsHint: "O programa ir\u00e1 calcular os pontos automaticamente",
  problemCreatorPrefix: "Prefixo",
  problemCreatorSolution: "Solu\u00e7\u00e3o",
  problemCreatorSuffix: "Sufixo",
  problemCreatorWriting: "Escrita",
