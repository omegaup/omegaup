...
const translations: { [key: string]: string; } = {
  ...
  admissionModeManualOnly: "Manual (Adicionar os nomes das contas dos seus alunos)",
  ...
  courseEditAdmissionModeDescription: "Manual: Apenas os alunos explicitamente convidados podem inscrever-se.\nCompartilhar URL: Qualquer pessoa com o link pode candidatar-se a inscrever-se. Al\u00e9m disso, pode adicionar manualmente o nome da conta de cada aluno.",
