...
const translations: { [key: string]: string; } = {
  ...
  courseCardDescriptionCourses: "<p>Os cursos do omegaUp s\u00e3o para</p><ul><li>Professores que desejam criar cursos online</li><li>Alunos participando dos cursos de suas aulas</li><li>Qualquer usu\u00e1rio que deseja aprender mais sobre programa\u00e7\u00e3o participando de cursos p\u00fablicos</li></ul>",
