...
const translations: { [key: string]: string; } = {
  ...
  token_corrupted: "Ocorreu um problema ao decodificar o token.",
  token_expired: "O token que voc\u00ea est\u00e1 tentando usar j\u00e1 expirou.",
  token_invalid: "O token n\u00e3o \u00e9 v\u00e1lido para este curso.",
