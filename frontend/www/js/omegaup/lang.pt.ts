...
const translations: { [key: string]: string; } = {
  ...
  contestNewFormAdmissionModeDescription: "Selecione o modo do concurso. Existem tr\u00eas modalidades diferentes:<br /><ul><li><b>Privado:</b> o concurso n\u00e3o aparece em nenhuma lista e os usu\u00e1rios n\u00e3o podem acess\u00e1-lo, a menos que tenham sido convidados explicitamente.</li><li><b>Registramento aberto:</b> Qualquer pessoa pode participar ap\u00f3s o registro, mas somente pessoas admitidas anteriormente podem participar oficialmente do concurso.</li><li><b>P\u00fablico:</b> todos podem participar.</li></ul>",
