...
const translations: { [key: string]: string; } = {
  ...
  courseEditAdmissionModeDescription: "Selecione o modo do curso. Existem dois modalidades diferentes:<br /><ul><li>Particular: o curso n\u00e3o aparece em nenhuma lista e os usu\u00e1rios n\u00e3o podem acess\u00e1-lo, a menos que tenham sido convidados explicitamente.</li><li>Inscri\u00e7\u00e3o/aberto: Qualquer pessoa pode participar ap\u00f3s o registro, mas somente pessoas admitidas anteriormente podem participar oficialmente do curso.</li></ul>",
