...
const translations: { [key: string]: string; } = {
  ...
  ephemeralGraderAlert: "Voc\u00ea precisa de uma tela maior para usar nosso Ephemeral Grader. Tente colocar o telefone na posi\u00e7\u00e3o horizontal ou usar outro dispositivo.",
