...
const translations: { [key: string]: string; } = {
  ...
  contestNewFormImmediatePartialFeedbackDesc: "Depois de avaliar cada submiss\u00e3o, o resumo do veredictos ser\u00e1 mostrado.",
  ...
  feedbackSubmissionContestSummary: "A porcentagem de veredictos de CA neste envio \u00e9 <strong>%(pctAC)%</strong>.<br>O veredicto mais baixo nesta submiss\u00e3o foi <strong>%(worstSubmissionVerdict)</strong>.",
