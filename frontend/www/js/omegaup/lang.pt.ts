...
const translations: { [key: string]: string; } = {
  ...
  notificationCourseRegistrationRequest: "O usu\u00e1rio <strong>%(username)</strong> tem solicitado acceso ao curso <a href='%(courseLink)'>%(courseName)</a>.",
  notificationNewBadge: "Voc\u00ea tem recebido um novo distintivo: <a href='%(badgeLink)'>%(badgeName)</a>",
