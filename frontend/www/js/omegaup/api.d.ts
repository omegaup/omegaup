...
namespace api {
  // Type aliases
  interface ProblemDatailsForSmaryItem {
    inContest: boolean;
    smartyProperties: {
      input_limit: string;
      ...
      payload: {
        ...
        settings: {
          cases: {
            [key: string]: { in: string; out: string; weight: numeric };
          };
          limits: {
            ExtraWallTime: numeric | string;
            MemoryLimit: numeric | string;
            OutputLimit: numeric | string;
  ...
  type BadgeMyBadgeAssignationTimeResponse = { assignation_time?: numeric };
  ...
  type ContestRoleResponse = { admin: boolean };
  ...
  type SchoolCreateResponse = { school_id: numeric };
