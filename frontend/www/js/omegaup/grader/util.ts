...
export const languageMonacoModelMapping: Record<string, string> = {
  cpp11: 'cpp',
  'cpp11-gcc': 'cpp',
  'cpp11-clang': 'cpp',
  'cpp17-gcc': 'cpp',
...
export const languageExtensionMapping: Record<string, string> = {
  cpp11: 'cpp',
  'cpp11-gcc': 'cpp',
  'cpp11-clang': 'cpp',
  'cpp17-gcc': 'cpp',
...
> = {
  ...
  kj: { extension: '', name: 'Karel (Java)', modelMapping: '', language: 'kj' },
  c: {
    extension: 'c',
    name: 'C11 (gcc 10.3)',
    modelMapping: 'cpp',
