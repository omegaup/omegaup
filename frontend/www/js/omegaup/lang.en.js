...
omegaup.OmegaUp.loadTranslations({
	...
	contestNewFormUserInformationRequiredDesc: "Enable this option to request access to the information of the participants that belong to the contest in order to be contacted later. Use \"Required\" option when the contest is preselective, otherwise you can use \"Optional\", keep in mind that in this case participants can choose whether they share their information or not.",
