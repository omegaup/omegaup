...
const translations = {
	...
	contestIntroDifferentStarts: "Once the contest has started, its duration will be %(window_length_hr)h%(window_length_min)m.",
	contestIntroPenaltyDesc: "Each incorrect submission will be penalized with a time of %(window_length_hr)h%(window_length_min)m.",
	contestIntroScoreboardTimePercent: "The scoreboard will be shown live for the first %(window_length_hr)h%(window_length_min)m of the contest.",
	...
	contestIntroSubmissionsSeparationDesc: "For each incorrect submission you must wait %(window_length_hr)h%(window_length_min)m to make a new submission.",
