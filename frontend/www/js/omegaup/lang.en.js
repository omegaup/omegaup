...
omegaup.OmegaUp.loadTranslations({
	...
	contestNewFormModality: "Admission mode",
	contestNewFormModalityDesc: "Select contest admission mode. There are three different modalities:<br /><ul><li>Private: Contest does not appear in any list, users can not access it, unless they have been explicitly invited.</li><li>Register/open: Anyone can join after registering, but only previously admitted people can officially participate in the contest.</li><li>Public: Everyone can participate.</li></ul>",
