...
const translations = {
	...
	badge_cppexpert_description: "The user solved more than 10 problems in C++.",
	...
	clockDays: "%(days) days, ",
	clockHour: "%(hour) hour, ",
	clockHours: "%(hours) hours, ",
	clockMinute: "%(minute) minute, ",
	clockMinutes: "%(minutes) minutes, ",
	clockMonth: "%(month) month, ",
	clockMonths: "%(months) months, ",
	clockSecond: "%(second) second.",
	clockSeconds: "%(seconds) seconds.",
	clockYear: "%(year) year, ",
	clockYears: "%(years) years, ",
	...
	wordsHours: "hours",
	wordsHumanReadable: "Human readable",
	wordsID: "ID",
