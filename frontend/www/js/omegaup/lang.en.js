...
omegaup.T = {
	...
	contestNewFormSubmissionsSeparationDesc: "Time in minutes that must pass before a contestant can send a new submission for the same problem after sending one: %(window_length) minutes",
