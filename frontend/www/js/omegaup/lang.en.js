...
omegaup.OmegaUp.loadTranslations({
	...
	wordsDangerZoneDesc: "Delete the problem.<br><br>This can only be done if the problem has not been used in a course or contest.<br><br>You must be very sure that you want to do it, because there is no way to recover it once it is removed.",
	wordsDelete: "Delete",
