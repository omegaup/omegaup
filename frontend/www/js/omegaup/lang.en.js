...
omegaup.OmegaUp.loadTranslations({
	...
	demotionProblemEmailBody: "Dear <strong>%1$s</strong>:<br><br>The access to your problem <strong>%2$s</strong> in omegaUp has been restricted because it was reported as inappropriate. The omegaUp team has reviewed this report and confirmed that the problem is not appropriate because <em>%3$s</em>.<br><br><br>To unblock the problem and have it appear again in the list of problems, please follow the steps below:<br><br>Review and edit your problem: make sure you describe a problem, it is not offensive or spam.<br>Once you have resolved the reason on why your problem was blocked, send an email <a href='mailto:omegaup@omegaup.com' target='_top'>omegaup@omegaup.com</a> to be reviewed and reactivated.<br><br>If the steps mentioned above are not followed, the problem will not be shown again in the list of problems, nor can it be used in competitions. In case of a relapse in three occasions, omegaUp reserves the right to suspend your user account.<br><br>omegaUp is a platform to help users improve their software engineering skills by solving code problems and competing in programing contests. omegaUp welcomes all the problems that help meet that goal.<br><br>Thanks,<br>omegaUp team",
	demotionProblemEmailSubject: "Problem %1$s has been reported as inappropriate",
	...
	qualityFormDifficulty: "What is the problem's difficulty?",
	...
	qualityFormQuality: "How likely are you to recommend this problem to someone else?",
	qualityFormQualityLikely: "Likely",
	qualityFormQualityNeutral: "Neutral",
	qualityFormQualityNotLikely: "Not Likely",
	qualityFormQualityVeryLikely: "Very Likely",
	qualityFormQualityVeryUnlikely: "Very Unlikely",
	qualityFormTags: "Tag this problem",
