...
omegaup.API = {
  ...
  getCourseList: function() {
    return omegaup.API._wrapDeferred(
      $.ajax({ url: '/api/course/listCourses/', dataType: 'json' }),
      function(result) {
  ...
  getContests: function(params) {
    return omegaup.API._wrapDeferred(
      $.ajax({ url: '/api/contest/list/', data: params, dataType: 'json' }),
      function(result) {
  ...
  _normalizeContestFields: function(contest) {
    omegaup.API._convertTimes(contest);
    contest.submission_deadline = omegaup.OmegaUp.time(
      contest.submission_deadline * 1000
    );
    contest.show_penalty = contest.penalty != 0 ||
  ...
  getContestPublicDetails: function(alias, callback) {
    $.get(
      '/api/contest/publicdetails/contest_alias/' +
  ...
  getProfile: function(username, callback) {
    $.get(
      ...
      function(data) {
        if (data.status == 'ok') {
          data.userinfo.birth_date = omegaup.OmegaUp.time(
  ...
  arbitrateContestUserRequest: function(
    contest_alias,
    username,
    resolution,
    notes,
  ...
  contestProblems: function(params) {
    return omegaup.API._wrapDeferred(
      $.ajax({ url: '/api/contest/problems/', data: params, dataType: 'json' })
    );
  },
  ...
  getMyProblems: function(params) {
    return omegaup.API._wrapDeferred(
      $.ajax({ url: '/api/problem/mylist/', data: params, dataType: 'json' })
    );
  },
  getMyContests: function(params) {
    return omegaup.API._wrapDeferred(
      $.ajax({ url: '/api/contest/mylist/', data: params, dataType: 'json' }),
      function(result) {
  ...
  getAdminProblems: function(params) {
    return omegaup.API._wrapDeferred(
      $.ajax({ url: '/api/problem/adminlist/', data: params, dataType: 'json' })
    );
  },
  ...
  getProblemClarifications: function(problemAlias, offset, rowcount, callback) {
    $.get(
      '/api/problem/clarifications/problem_alias/' +
        encodeURIComponent(problemAlias) +
        '/offset/' +
        offset +
        '/rowcount/' +
  ...
  getRankByProblemsSolved: function(rowcount, callback) {
    $.get(
      '/api/user/rankbyproblemssolved/rowcount/' +
  ...
  rejudgeProblem: function(problemAlias, callback) {
    $.get(
      '/api/problem/rejudge/problem_alias/' +
        encodeURIComponent(problemAlias) +
        '/',
      function(data) {
        callback(data);
  ...
  getRanking: function(contestAlias, callback) {
    $.get(
      '/api/contest/scoreboard/contest_alias/' +
        encodeURIComponent(contestAlias) +
        '/',
      function(data) {
        callback(data);
  ...
  getRankingEventsByToken: function(contestAlias, token, callback) {
    $.get(
      '/api/contest/scoreboardevents/contest_alias/' +
        encodeURIComponent(contestAlias) +
        '/token/' +
        encodeURIComponent(token) +
        '/',
  ...
  getRankByProblemsSolved: function(offset, rowcount, callback) {
    $.get(
      '/api/user/RankByProblemsSolved/offset/' +
  ...
  getScoreboardMerge: function(contestAliases, callback) {
    $.get(
      '/api/contest/scoreboardmerge/contest_aliases/' +
  ...
  getClarifications: function(contestAlias, offset, count, callback) {
    $.get(
      '/api/contest/clarifications/contest_alias/' +
        encodeURIComponent(contestAlias) +
        '/offset/' +
        encodeURIComponent(offset) +
        '/rowcount/' +
  ...
  addUsersToInterview: function(interviewAlias, usernameOrEmailsCSV, callback) {
    $.post(
      '/api/interview/addUsers/interview_alias/' +
  ...
  getInterview: function(alias, callback) {
    $.get(
      '/api/interview/details/interview_alias/' +
        encodeURIComponent(alias) +
        '/',
      function(data) {
        callback(data);
  ...
  getInterviewStatsForUser: function(interviewAlias, username, callback) {
    $.get(
      '/api/user/interviewstats/username/' +
        encodeURIComponent(username) +
        '/interview/' +
        encodeURIComponent(interviewAlias),
      function(data) {
