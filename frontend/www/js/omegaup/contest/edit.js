...
OmegaUp.on('ready', function() {
    ...
    API.Contest.problems({contest_alias: contestAlias}).then(function(responseProblems) {
    API.Contest.users({contest_alias: contestAlias}).then(function(responseUsers) {
    API.Contest.admins({contest_alias: contestAlias}).then(function(responseAdmins) {
                    ...
                    on: {
                        ...
                        addProblem: function(ev) {
                            ...
                            .then(function(response) {
                                UI.success('Problem successfully added!');
                            })
                            .fail(UI.apiError);
                        },
                        removeProblem: function(problem) {
                            ...
                            .then(function(response) {
                                UI.success("Problem successfully removed!");
                            })
                            .fail(UI.apiError);
                        },
