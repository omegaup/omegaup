...
const translations: { [key: string]: string; } = {
  ...
  helpVisit: "Visit",
  helpWelcomeMessage: "Welcome to the omegaUp help center! Here you will find resources to help you make the most of the platform.",
