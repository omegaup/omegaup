...
const translations: { [key: string]: string; } = {
  ...
  contestNewFormAliasHelp: "Only lowercase letters, numbers, and hyphens. Cannot be changed later.",
  contestNewFormAliasInvalid: "Alias can only contain lowercase letters, numbers, and hyphens",
