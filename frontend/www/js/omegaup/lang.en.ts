...
const translations: { [key: string]: string; } = {
  ...
  arenaRunSubmitTutorialTitle: "Submission Tutorial",
  arenaRunSubmitTutorialWelcome: "Welcome! This quick guide will help you submit your solution. Let's get started!",
  arenaRunSubmitTutorialLanguageTitle: "Select Language",
  arenaRunSubmitTutorialLanguageIntro: "Choose the programming language for your solution from this dropdown menu.",
  arenaRunSubmitTutorialEditorTitle: "Code Editor",
  arenaRunSubmitTutorialEditorIntro: "Type or paste your solution code here. The editor supports syntax highlighting for your selected language.",
  arenaRunSubmitTutorialUploadTitle: "File Upload",
  arenaRunSubmitTutorialUploadIntro: "Alternatively, you can upload a file containing your solution code instead of typing it directly.",
  arenaRunSubmitTutorialSubmitTitle: "Submit Solution",
  arenaRunSubmitTutorialSubmitIntro: "Click this button to submit your solution. Make sure you've selected a language and entered your code!",
  ...
  contestEditContestEdited: "Your contest has been edited! <a href=\"/arena/%(alias)/\">View contest</a>",
