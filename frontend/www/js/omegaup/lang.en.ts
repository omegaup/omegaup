...
const translations: { [key: string]: string; } = {
  ...
  problemCreatorAutomaticPoints: "Auto Points",
  problemCreatorAutomaticPointsHelper: "The program will calculate the points of each case depending of the number of cases. If there are 4 cases, then the points of each case will be 25 (The cases that have already been manually assigned will not be taken into account by this calculation)",
