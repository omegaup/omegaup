...
const translations: { [key: string]: string; } = {
  ...
  contestNewFormPartialScoreDesc: "The score of submissions will be calculated by the weight of all case with AC verdict. Otherwise, the score will be 0 in case of at least one case is wrong.",
