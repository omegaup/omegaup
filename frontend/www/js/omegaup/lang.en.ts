...
const translations: { [key: string]: string; } = {
  ...
  certificateValidationCertifyValidity: "omegaUp certifies the validity of the following diploma",
  certificateValidationEnteredCode: "Entered code: %(code)",
  certificateValidationInvalid: "INVALID",
  certificateValidationNotFound: "No diploma with the code %(code) was found in the database. If you think this is an error please contact us at hello@omegaup.com.",
  certificateValidationStatus: "Status: ",
  certificateValidationTitle: "Verify Diploma",
  ...
  omegaupTitleCertificateValidation: "Verify diploma",
