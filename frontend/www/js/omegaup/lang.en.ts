...
const translations: { [key: string]: string; } = {
  ...
  contestListEmptyDescription: "Create your first contest to start organizing programming competitions.",
  ...
  problemListEmptyDescription: "Create your first problem to start sharing it with others.",
  problemListEmptyTitle: "You have not created any problems yet",
  ...
  qualityNominationListEmptyDescription: "Here you can track the status of problems you have reported.",
  qualityNominationListEmptyTitle: "No problem reports yet",
  ...
  runsListEmptyDescription: "There are no submissions in the platform to display.",
  runsListEmptyTitle: "No submissions yet",
