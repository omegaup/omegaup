...
const translations: { [key: string]: string; } = {
  ...
  contestCanNotChangeToContestForTeams: "A normal contest can not change to contest for teams",
  ...
  contestForTeamsCanNotChangeToContest: "A contest for teams can not change to normal contest",
  ...
  groupsCanNotBeAddedInContestForTeams: "Groups can not be added in contests for teams",
  ...
  submissionFeedbackUpdateButton: "Update feedback for the student \ud83d\udd3d",
  ...
  usersCanNotBeAddedInContestForTeams: "Users can not be added in contests for teams",
  verdictAC: "Accepted",
