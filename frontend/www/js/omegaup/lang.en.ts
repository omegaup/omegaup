...
const translations: { [key: string]: string; } = {
  ...
  courseAddProblemsAddAssignmentDesc: "Add all the problems what you want include to the assignment. These problems will be stored until you press Schedule assignment button. If you still do not decide  what problems to use, you can add them later.",
  ...
  homeworksOrderUpdated: "Homeworks' order has been updated",
  ...
  testsOrderUpdated: "Tests' order has been updated",
