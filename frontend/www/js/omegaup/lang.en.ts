...
const translations: { [key: string]: string; } = {
  ...
  helpAdditionalResources: "Additional Resources",
  helpAlgorithmsBook: "Algorithms Book",
  helpAlgorithmsBookDesc: "Access our comprehensive guide to algorithms and data structures.",
  helpBlog: "omegaUp Blog",
  helpBlogDesc: "Read the latest news, updates, and articles from the omegaUp team.",
  helpDescription: "Find resources to help you get started with omegaUp and competitive programming.",
  helpDiscord: "Discord Community",
  helpDiscordDesc: "Join our Discord server to chat with other users and get help.",
  helpDocumentation: "Documentation",
  helpDocumentationDesc: "Browse our technical documentation and problem-writing guides.",
  helpGitHub: "GitHub Repository",
  helpGitHubDesc: "Explore our open-source code and contribute to the project.",
  helpTutorials: "Video Tutorials",
  helpTutorialsDesc: "Watch step-by-step video tutorials to learn competitive programming.",
  helpVisit: "Visit",
  helpWelcomeMessage: "Welcome to omegaUp's help center! Here you can find resources, tutorials, and community support to get started.",
