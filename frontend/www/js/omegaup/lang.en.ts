...
const translations: { [key: string]: string; } = {
  ...
  problemCreatorAllGroupCasesWillBeDeleted: "All the cases of this group will be deleted",
  problemCreatorAutoPoints: "Autopoints",
  problemCreatorCancel: "Cancel",
  problemCreatorCantUndo: "This action cannot be undone",
  problemCreatorCase: "Case",
  problemCreatorCaseName: "Case Name",
  problemCreatorCaseNameHint: "Lowercase and without spaces",
  problemCreatorCaseNumber: "Number of cases",
  problemCreatorCaseNumberHint: "The testcases will have the name of ",
  problemCreatorCases: "Testcases",
  problemCreatorCreateProblem: "Create Problem",
  problemCreatorDelete: "Delete",
  problemCreatorDeleteAllCases: "Delete all cases",
  problemCreatorDeleteGroup: "Remove group",
  problemCreatorDeleteGroupCasesConfirmation: "Are you sure you want to delete all the testcases from this group?",
  problemCreatorDeleteGroupConfirmation: "Are you sure you want to delete this group?",
  problemCreatorEdit: "Edit",
  problemCreatorEditGroup: "Edit group",
  ...
  problemCreatorMulticase: "Multiple Cases",
  problemCreatorName: "Name",
  problemCreatorNamePlaceholder: "New Problem",
  problemCreatorNewProblem: "New Problem",
  problemCreatorNoGroup: "no_group",
  problemCreatorPoints: "Points",
  problemCreatorPointsHint: "The program will calculate the points automatically",
