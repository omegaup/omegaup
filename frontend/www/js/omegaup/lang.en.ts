...
const translations: { [key: string]: string; } = {
  ...
  contestAdmissionModeDescription: "Select contest admission mode. There are three different modalities:- *Private:* Contest does not appear in any list, users can not access it, unless they have been explicitly invited.\n\n- *Registration/open:* Anyone can join after registering, but only previously admitted people can officially participate in the contest.\n\n- *Public:* Everyone can participate.",
