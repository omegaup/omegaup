...
const translations: { [key: string]: string; } = {
  ...
  textEditorEnterText: "Enter text here...",
  textEditorNoOutput: "No output available.",
  textEditorOutputTruncated: "\n\n... [OUTPUT TRUNCATED: Exceeded character limit].",
  textEditorPlainEditorAria: "Plain text editor for %(filename)s.",
  textEditorToolbarAria: "Toolbar for %(filename)s.",
