...
const translations: { [key: string]: string; } = {
  ...
  certificateDetailsBody: "Please send us an email to <a href=\"mailto:certificates@omegaup.com?subject=Verification of certificate %(uuid)\" target=\"blank\">certificates@omegaup.com</a> to verify a certificate. Make sure to include the ID of the certificate (%(uuid)) in the subject.",
