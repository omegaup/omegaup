...
const translations: { [key: string]: string; } = {
  ...
  acceptPrivacyPolicy: "I have read and accept the site's [Use and Privacy Policy](https://blog.omegaup.com/policies/privacy-policy/), as well as the [Code of Conduct](https://blog.omegaup.com/codigo-de-conducta-en-omegaup/).",
  ...
  viewAclListRolesForUsername: "Roles for",
  viewAclListSelectAUser: "Select a user",
  viewAclListUsernameTotalRoles: "Username (total roles)",
