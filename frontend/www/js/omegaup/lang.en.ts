...
const translations: { [key: string]: string; } = {
  ...
  courseAddLecturesAddAssignmentDesc: "Add all the lectures that you want to include. These lectures will be stored until you press the Add content button. If you do not want to decide which lectures to use right now, you can add them later.",
