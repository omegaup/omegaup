...
const translations: { [key: string]: string; } = {
  ...
  carouselDeleteConfirm: "Delete carousel item",
  carouselDeleteMessage: "Are you sure you want to delete this carousel item? This action cannot be undone.",
