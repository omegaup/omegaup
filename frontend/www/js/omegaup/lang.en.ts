...
const translations: { [key: string]: string; } = {
  ...
  courseCardDescriptionCourses: "Description:<br>The courses at omegaUp are for<br>- Teachers who want to create online courses<br>- Students participating in the courses of their classes<br>- Any user who wants to learn more about programming by participating in public courses",
