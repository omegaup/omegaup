...
const translations: { [key: string]: string; } = {
  ...
  bulkUserAddError: "There was an error adding accounts. The following names or emails were not found in omegaUp:<br><br><b>%(userEmail)</b>.<br><br>However, the rest of accounts have been added successfully.",
