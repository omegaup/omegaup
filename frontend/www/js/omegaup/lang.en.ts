...
const translations: { [key: string]: string; } = {
  ...
  activityReportDuplicatesForOriginsDescription: "Addresses with more than one coder",
  activityReportDuplicatesForUsersDescription: "Coders with more than one address",
  activityReportEvent: "Event",
  activityReportNoDuplicatesForOrigins: "There are no addresses with more than one coder",
  activityReportNoDuplicatesForUsers: "There are no coders with more than one address",
  ...
  addUsersMultipleOrSingleUser: "Add single or multiple coders",
  addUsersToReviewerGroup: "Click to add a coder to the list of reviewers.",
  ...
  banningProblemDueToReport: "Banning problem due to coder report.",
  birthdayInTheFuture: "You are not old enough to use omegaUp",
  bulkOperationError: "There was an error executing the operation",
  bulkUserAddError: "There was an error adding coders. The following usernames or emails were not found in omegaUp:<br><br><b>%(userEmail)</b>.<br><br>However, the rest of coders have been added successfully.",
  bulkUserAddSuccess: "Coders successfully added!",
  ...
  contestInformationNotRequired: "Coder information for this contest was not required.",
  ...
  contestNewFormForTeamsDesc: "If activated, the contest can only be accessed by teams instead of coders or identities. The teams have to be added to a teams group.",
  ...
  contestNewFormNoPenalty: "Coders with the same score will end up in a draw, regardless of the time it has taken each one.",
  ...
  contestNewFormUserInformationRequiredDesc: "Choose \"Optional\" if you would want to ask the coders for their permission to share their information. They can then decide whether or not to share it, and they will be able to participate on the contest regardless. If you cannot allow them to participate without sharing their information, choose \"Required\", but keep in mind that some coders will simply choose to not participate at all.",
  ...
  contestRegistrationPreAcceptedDescription: "Coder has been explicitly invited to the contest",
  ...
  courseCloneGenerateLinkDescription: "Any coder with whom you share this link can use it to clone the course for a period of 7 days",
  ...
  courseDoesNotAdmitRegistration: "Course doesn't admit coder registration",
  ...
  courseIntroImpartedBy: "Imparted by",
  ...
  courseListSubmissionsByGroup: "Submissions made by coders of this course",
  ...
  courseRegistrationPreAcceptedDescription: "Coder has been explicitly invited to the course",
  ...
  identityAlreadyInUse: "Identity is already used by another coder.",
  ...
  loginEmail: "E-mail",
  loginEmailUsername: "E-mail or coder",
  ...
  loginThroughThirdParty: "Your coder was created through a third-party login (Google, Facebook, etc.). Please login using that mechanism again in order to set a password.",
  ...
  mustUpdateBasicInfoToFilterUsers: "You must update your basic information to filter coders in the ranking.",
  ...
  notificationCourseRegistrationRequest: "The coder **%(username)** has requested access to course %(courseName).",
  ...
  omegaupTitleAdminUsers: "Coder administration",
  ...
  omegaupTitleUsersRank: "Coder ranking",
  ...
  problemsetIdentityNotFound: "Coder or identity are not associated with this course, contest or task.",
  ...
  profileSchoolMonthlySolvedProblemsCount: "Monthly solved problems count for the coders of %(school)",
  ...
  profileStatisticsVerdictsOf: "Verdicts of %(coder)",
  ...
  schoolUsers: "Coders who belong to this school",
  ...
  singleUserAddSuccess: "Coder successfully added.",
  ...
  unverifiedUser: "Unverified coder.",
  ...
  userAlreadyAcceptedPrivacyPolicy: "Coder has already accepted the privacy policy",
  userAlreadyHasSelectedRole: "Coder already has the selected role",
  userBirthDate: "Birth date: %(birthDate)",
  userDoesNotHaveAnyPasswordChangeRequest: "Coder does not have any password change request in the last 24 hours.",
  ...
  userEmails: "E-mails",
  userEndTimeUpdatedSuccessfully: "Contest end time for coder has been updated successfully.",
  userGroups: "Groups",
  userInformationIsPrivate: "The coder's information is private",
  userLastLogin: "Last login: %(lastLogin)",
  userNeverLoggedIn: "Has never logged in.",
  userNotAllowed: "Coder is not allowed to perform action.",
  userNotExist: "Coder does not exist.",
  userNotInListOfRequests: "The coder is not pending request to join.",
  ...
  userProfileIsPrivate: "This coder's profile is marked private; some information will not be displayed",
  userRankOfTheMonthHeader: "Top %(count) coders with the most points in the month",
  userRemoveSuccess: "Coder successfully removed!",
  userRoles: "Roles",
  userVerified: "Coder has been verified",
  userVerify: "Verify coder",
  username: "Username",
  usernameInUse: "Username already exists.",
  usernameOrPassIsWrong: "Username or password is wrong. Please check your credentials.",
  usersCanNotBeAddedInContestForTeams: "Coders cannot be added in contests for teams",
  verdictAC: "Accepted",
  ...
  verificationEmailBody: "Welcome to omegaUp! Please click on the following link to login and verify your email: <a href=\"https://omegaup.com/coder/verifyemail/%(verification_id)/\">https://omegaup.com/coder/verifyemail/%(verification_id)/</a>",
  ...
  wordsMonths: "Months",
  wordsMultipleUser: "Multiple coders (Separated by commas or line breaks)",
