...
const translations: { [key: string]: string; } = {
  U13HasNotBeenVerifiedForTheirParent: "This is an account for minors and has not been verified by a parent or guardian. The account will be blocked and unable to see content.",
  ...
  accountVerifyWarning: "Your parent or guardian must approve this account, otherwise it will be deleted in %(days) days",
