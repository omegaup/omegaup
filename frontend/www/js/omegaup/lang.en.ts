...
const translations: { [key: string]: string; } = {
  ...
  courseArchivedSuccess: "Course arquived successfully.",
  ...
  courseUnarchivedSuccess: "Course unarquived succesfully.",
  ...
  helpIntroNeedHelpToSendSubmission: "Do you need help to send a new submission?",
  helpIntroNewRun: "Click here to open the window where you will send the solution",
  helpIntroNext: "Next",
  helpIntroPrevious: "Previous",
  helpIntroSkip: "Skip",
