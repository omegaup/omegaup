...
const translations: { [key: string]: string; } = {
  ...
  privacyPolicyNotAccepted: "Please read and accept the site's [Use and Privacy Policy](http://blog.omegaup.com/privacy-policy/), as well as the [Code of Conduct](https://blog.omegaup.com/codigo-de-conducta-en-omegaup/).",
