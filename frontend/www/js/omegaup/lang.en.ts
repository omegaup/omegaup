...
const translations: { [key: string]: string; } = {
  ...
  contestNewFormForTeamsDesc: "If activated, only can be accessed by teams instead of users or identities. The teams have to be added to a teams group. For more information click here.",
