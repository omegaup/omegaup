...
const translations: { [key: string]: string; } = {
  ...
  coderOfTheMonthNotice: "Hi %(username)! Congratulations on winning the recognition to Coder of the Month! We have a prize for you, please contact us at mentores@omegaup.org",
