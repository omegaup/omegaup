...
const translations: { [key: string]: string; } = {
  ...
  admissionModePublic: "Public (Students enroll from the list of public courses only if it's set as recommended)",
  ...
  courseEditRequestSetRecommendedCourse: "If you are interested in having your course in the public courses list, please contact [hello@omegaup.com](mailto:hello@omegaup.com) indicating the course alias for review.",
