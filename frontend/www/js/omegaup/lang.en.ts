...
const translations: { [key: string]: string; } = {
  ...
  courseAddProblemsAddAssignmentDesc: "Add all the problems that you want to include. These problems will be stored until you press Add content button. If you do not want to decide which problems to use right now, you can add them later.",
  ...
  courseAssignmentNewFormShortTitle_alias_Desc: "The alias is used to construct the URL (examples: HOMEWORK1, FINALTEST)",
  ...
  courseUpdateAlreadyHasRuns: "The duration length can't be changed once a solution has been judged.",
