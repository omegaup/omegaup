...
const translations: { [key: string]: string; } = {
  ...
  courseCardDescriptionCourses: "<p>Description:</p><p>The courses at omegaUp are for</p><ul><li>Teachers who want to create online courses</li><li>Students participating in the courses of their classes</li><li>Any user who wants to learn more about programming by participating in public courses</li></ul>",
  ...
  courseEditAdmissionModeDescription: "Select course admission mode. There are two different options:<br /><ul><li>Manual only: Students can not access it unless they have been explicitly invited.</li><li>Share URL: Anyone with the link can apply to join. Additionally you can manually add usernames to your course.</li></ul>",
  ...
  problemDeployerNoEsStatement: "No statement/es.markdown found.",
  ...
  problemDifficultyIntro: "Introductory",
  ...
  problemTagOutputOnly: "Output only",
