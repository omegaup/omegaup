...
const translations: { [key: string]: string; } = {
  ...
  codeTesterCode: "Code",
  codeTesterCodePlaceholder: "Enter your code here...",
  codeTesterCompileError: "Compilation Error",
  codeTesterConfiguration: "Configuration",
  codeTesterDescription: "Test your code with custom test cases and view execution metrics",
  codeTesterErrorCompileFailed: "Compilation failed",
  codeTesterErrorHttp: "HTTP error",
  codeTesterErrorInvalidResponse: "Invalid response format from grader",
  codeTesterErrorNoCode: "Please enter code to test",
  codeTesterErrorNoResults: "No run results found",
  ...
  codeTesterLanguage: "Language",
  codeTesterMemoryUsage: "Memory Usage",
  codeTesterOutput: "Output",
  codeTesterPlaceholder: "Write your code and click 'Run Code' to see results here",
  codeTesterResult: "Results",
  codeTesterRun: "Run Code",
  codeTesterRunning: "Running...",
  codeTesterSeconds: "seconds",
  codeTesterSuccessMessage: "Code executed successfully!",
  codeTesterTimeLimit: "Time Limit",
  codeTesterTimeLimitHelp: "Maximum execution time allowed (0.1 to 10 seconds)",
