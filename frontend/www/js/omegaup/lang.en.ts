...
const translations: { [key: string]: string; } = {
  U13HasNotBeenVerifiedForTheirParent: "User U13 has not been verified by their parent So account will be blocked and unable to consume content",
  ...
  accountVerifyWarning: "Your parent or Guardian must approve your account otherwise it will be deleted in  %(days) days",
