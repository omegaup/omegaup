...
const translations: { [key: string]: string; } = {
  ...
  bulkUserAddError: "There was an error adding users. The following usernames or emails was not found in omegaUp:<br><br><b>%(userEmail)</b>.<br><br>However, the rest of users has been added successfully.",
