...
const translations: { [key: string]: string; } = {
  ...
  problemAddNoContests: "You have no active contests as an administrator.",
  problemAddNoCourses: "You have no courses with active assignments, lessons, or exams as an administrator.",
  problemAddSelectAssignment: "Select an assignment or exam",
  problemAddSelectContest: "Select a contest",
  problemAddSelectCourse: "Select a course",
  problemAddToContest: "Add to a contest",
  problemAddToContestOrCourse: "Add to a contest or course",
  problemAddToCourse: "Add to a course",
  problemAddedToContestSuccess: "The problem was successfully added to the contest.",
  problemAddedToCourseSuccess: "The problem was successfully added to the course.",
