...
const translations: { [key: string]: string; } = {
  ...
  studentProgressDescription: "Score: %(score) of %(points) possible points.<br />Progress: %(progress)%",
  studentProgressTooltipDescription: "Problem: %(problem)<br />Score: %(score) of %(points) possible points.<br />Progress: %(progress)%",
