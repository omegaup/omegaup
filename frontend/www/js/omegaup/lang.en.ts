...
const translations: { [key: string]: string; } = {
  ...
  dependentsRedMessage: "Attention! You only have 1 day left to approve your dependent's account. Otherwise, the account will be deleted.",
  ...
  mailFromUserLikelyRemoved: "This mail is already in use. Probably it was used but the account was removed. If you want to use this email please contact omegaup-soporte@googlegroups.com for support",
