...
const translations: { [key: string]: string; } = {
  ...
  contestNewFormAdmissionModeDescription: "Select contest admission mode. There are three different modalities:<br /><ul><li><b>Private:</b> Contest does not appear in any list, users can not access it, unless they have been explicitly invited.</li><li><b>Registration/open:</b> Anyone can join after registering, but only previously admitted people can officially participate in the contest.</li><li><b>Public:</b> Everyone can participate.</li></ul>",
