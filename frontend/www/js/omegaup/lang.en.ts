...
const translations: { [key: string]: string; } = {
  ...
  localStorageDraftAutosaveUnavailable: "localStorage is unavailable - draft autosave is disabled",
  localStorageDraftRestored: "Draft restored from previous session",
  localStorageQuotaExceeded: "localStorage quota exceeded. Cannot save draft.",
  localStorageUnavailableInBrowsingMode: "localStorage is unavailable - draft autosave is disabled",
  locale: "en",
