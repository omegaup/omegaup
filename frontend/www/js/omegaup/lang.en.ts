...
const translations: { [key: string]: string; } = {
  ...
  helpHowToWriteProblems: "How to write problems for omegaUp",
  helpPageAdditionalResources: "Additional Resources",
  helpPageDescription: "Welcome to omegaUp's help center! Here you can find resources, tutorials, and community support to get started.",
  helpResourceAlgorithmsBook: "Algorithms Book",
  helpResourceAlgorithmsBookDescription: "Access our comprehensive guide to algorithms and data structures.",
  helpResourceBlog: "omegaUp Blog",
  helpResourceBlogDescription: "Read the latest news, updates, and articles from the omegaUp team.",
  helpResourceDiscord: "Discord Community",
  helpResourceDiscordDescription: "Join our Discord server to chat with other users and get help.",
  helpResourceDocumentation: "Documentation",
  helpResourceDocumentationDescription: "Browse our technical documentation and problem-writing guides.",
  helpResourceGithub: "GitHub Repository",
  helpResourceGithubDescription: "Explore our open-source code and contribute to the project.",
  helpResourceTutorials: "Video Tutorials",
  helpResourceTutorialsDescription: "Watch step-by-step video tutorials to learn competitive programming.",
  helpVisitResource: "Visit",
