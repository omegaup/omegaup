...
const translations: { [key: string]: string; } = {
  ...
  graderCannotSaveEmptyTemplate: "Cannot save empty template",
  graderClearForm: "Clear Form",
  graderClickToEdit: "Click to edit",
  graderCodeCopied: "Code copied to template",
  graderCodeCopiedToTemplate: "Code copied to template",
  graderConfirmDeleteTemplate: "Are you sure you want to delete this template?",
  graderCreateNewTemplate: "Create New Template",
  graderDeleteTemplate: "Delete Template",
  graderEditTemplate: "Edit Template",
  graderLoadTemplate: "Load into editor",
  graderManageTemplates: "Manage Templates",
  graderMaxLength: "Max length",
  graderMyTemplates: "My Templates",
  graderNoTemplatesFound: "No templates found for this language",
  graderNoTemplatesYet: "No templates saved yet. Create your first template!",
  graderRenameTemplate: "Rename Template",
  graderRequired: "Required",
  graderSaveAsNewTemplate: "Save as New Template",
  graderTemplateCode: "Template Code",
  graderTemplateCodePlaceholder: "Enter your code template here...",
  graderTemplateDeleteFailed: "Failed to delete template",
  graderTemplateDeleted: "Template deleted successfully",
  graderTemplateInfoText: "Save code templates for quick reuse across problems",
  graderTemplateLoaded: "Template loaded into editor",
  graderTemplateManagement: "Template Management",
  graderTemplateName: "Template Name",
  graderTemplateNamePlaceholder: "Enter template name",
  graderTemplateNameRequired: "Template name is required",
  graderTemplateNameTooLong: "Template name is too long (max 100 characters)",
  graderTemplateRenamed: "Template renamed successfully",
  graderTemplateSaveFailed: "Failed to save template",
  graderTemplateSaved: "Template saved successfully",
  graderTemplates: "Templates",
  graderUseCurrentCode: "Use Current Code",
  graderUseCurrentCodeTooltip: "Copy code from editor to template",
  graderYourSavedTemplates: "Your Saved Templates",
