...
const translations: { [key: string]: string; } = {
  ...
  bookmarkedProblemsDesc: "Problems you saved for later",
  ...
  carouselArchive: "Archive",
  carouselButtonTitle: "Button title",
  carouselCreate: "Create",
  carouselCreateNew: "Create new carousel item",
  carouselDeleteConfirm: "Archive carousel item",
  carouselDeleteMessage: "Are you sure you want to archive this carousel item?",
  carouselEditItem: "Edit carousel item",
  carouselExcerpt: "Excerpt",
  carouselExpirationDate: "Expiration date",
  carouselExpirationDateHint: "Leave empty for no expiration",
  carouselExpire: "Expired",
  carouselImageUrl: "Image URL",
  carouselInactive: "Inactive",
  carouselItemArchived: "Carousel item archived successfully",
  carouselItemCreated: "Carousel item created successfully",
  carouselItemNotFound: "Carousel item not found",
  carouselItemUpdated: "Carousel item updated successfully",
  carouselLink: "Link",
  carouselNoExpiration: "No expiration",
  carouselNoImage: "No image",
  carouselNoItems: "No carousel items found",
  carouselStatusActive: "Active",
  carouselStatusAll: "All",
  carouselStatusArchived: "Archived",
  ...
  contentCreationRateLimitExceeded: "You have exceeded the maximum number of allowed creations per hour. Please try again later.",
  ...
  contestsCreateDesc: "Host your own competition",
  contestsJoinScoreboards: "Merge Scoreboards",
  contestsJoinScoreboardsDesc: "Merge scoreboards from several contests",
  ...
  createProblemInteractiveGuideCreationMethod: "Select the method to create the problem (using Problem Creator or uploading a zip file).",
  createProblemInteractiveGuideFile: "Upload the .zip file with the problem information.",
  createProblemInteractiveGuideOpenCreator: "Open the interactive Problem Creator to build your problem directly in the browser.",
  ...
  cronControlPlaneScheduleDaily: "every day at %(time)",
  cronControlPlaneScheduleEveryMinutes: "every %(minutes) minutes",
  cronControlPlaneScheduleHourly: "every hour at minute %(minute)",
  cronControlPlaneScheduleMonthly: "day %(dayOfMonth) of every month at %(time)",
  cronControlPlaneScheduleWeekly: "every %(weekday) at %(time)",
  ...
  emailVerificationButton: "Verify My Email",
  emailVerificationClosing: "Happy coding!<br>The omegaUp Team \u2764\ufe0f",
  emailVerificationInstruction: "To complete your registration and start solving problems, please verify your email address:",
  emailVerificationSecurityNotice: "If you didn't create this account, please ignore this email.",
  emailVerificationSubtext: "Or copy and paste this link in your browser:",
  emailVerificationWelcomeIntro: "Thank you for creating your account. You're now part of a vibrant community of competitive programmers.",
  emailVerificationWelcomeTitle: "Welcome to omegaUp!",
  ...
  ephemeralGraderDescription: "Allow users to use the EphemeralGrader IDE to test their code directly on the platform.",
  ephemeralGraderDisabled: "The EphemeralGrader IDE is currently disabled.",
  ephemeralGraderEnable: "Enable EphemeralGrader IDE",
  ephemeralGraderUpdated: "Ephemeral Grader settings updated",
  ...
  navAuthorRankingDesc: "Top problem authors",
  navBlog: "Blog",
  navBlogDesc: "Platform updates and articles",
  navCoderOfTheMonth: "Coder of the month overall",
  navCoderOfTheMonthDesc: "Monthly featured coder",
  navCoderOfTheMonthFemale: "Coder of the month for her",
  navCoderOfTheMonthFemaleDesc: "Monthly featured female coder",
  navCompareUsers: "Compare Users",
  navCompareUsersDesc: "Compare two users side by side",
  ...
  navCreateProblemFromScratch: "Create Problem from Scratch",
  navCreateProblemFromScratchDesc: "Build a new problem step by step",
  navCreateProblemFromZip: "Create Problem from ZIP",
  navCreateProblemFromZipDesc: "Upload a problem zip file you already have",
  ...
  navQualityNominationQueueDesc: "Review community nominations",
  navRanking: "Ranking",
  navSchoolOfTheMonth: "School of the month",
  navSchoolOfTheMonthDesc: "Monthly featured school",
  navSchoolRanking: "School ranking",
  navSchoolRankingDesc: "Top schools by activity",
  ...
  navUserRankingDesc: "Top users by score",
  navViewBadges: "View badges",
  navViewContests: "View Contests",
  navViewContestsDesc: "Compete in live and past contests",
  navViewCourses: "View Courses",
  navViewCoursesDesc: "Learn with guided problem sets",
  navViewLatestSubmissions: "View Latest Submissions",
  navViewLatestSubmissionsDesc: "Recent runs across the site",
  navViewProblems: "Browse Problems",
  navViewProblemsAll: "Problems List",
  navViewProblemsAllDesc: "The full problem catalog",
  navViewProblemsDesc: "Browse problems by topic",
  ...
  omegaupTitleCarouselManagement: "Carousel Management",
  ...
  openInReKarel: "You can use ReKarel 2.0.0 to solve this problem.",
  ...
  profile: "Name",
  profileAboutSection: "About Me",
  profileAboutSectionAddPrompt: "Add a section to tell visitors about yourself.",
  profileAboutSectionReport: "Report profile",
  profileAboutSectionReportSuccess: "Report submitted. Thank you.",
  ...
  runsListEmptyDescription: "There are no runs to show at this moment.",
  runsListEmptyTitle: "No runs to show",
  ...
  verificationEmailSubject: "Welcome to omegaUp! Verify your email",
  ...
  wordsEphemeralGrader: "Ephemeral Grader",
  wordsExam: "Exam",
