...
const translations: { [key: string]: string; } = {
  ...
  helpResourceAlgorithmsBookDescription: "The best resource to start learning algorithms and data structures.",
  helpResourceBlog: "Blog",
  helpResourceBlogDescription: "Read our tutorials and follow our announcements entirely in Spanish!",
  helpResourceDiscord: "Discord",
  helpResourceDiscordDescription: "Discuss with the community about our problems and contests.",
  helpResourceDocumentation: "Documentation",
  helpResourceDocumentationDescription: "Read the documentation on how to use omegaUp.",
  helpResourceGithub: "GitHub",
  helpResourceGithubDescription: "Report bugs or contribute to the open source project.",
  helpResourceTutorials: "Tutorials",
  helpResourceTutorialsDescription: "Learn the basics of competitive programming.",
