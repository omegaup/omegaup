...
const translations: { [key: string]: string; } = {
  ...
  buttonGoToCreateProblem: "Go Create a problem",
  ...
  contestNewFormImmediatePartialFeedbackDesc: "After evaluating each submission the summary of verdicts willl be shown.",
  ...
  feedbackSubmissionContestSummary: "The percentage of AC verdicts in this submission is <strong>%(pctAC)%</strong>.<br>The lowest verdict in this submmission has been <strong>%(worstSubmissionVerdict)</strong>.",
