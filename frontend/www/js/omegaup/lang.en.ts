...
const translations: { [key: string]: string; } = {
  ...
  loginEmail: "E-mail",
  loginEmailParent: "Parent's e-mail",
  ...
  loginParentEmailRequired: "The parent email is required.",
  loginPassword: "Password",
  loginPasswordCreate: "Password (Min. 8 characters)",
  loginPasswordTooShort: "Password is too short.",
  loginPrivacyPolicyRequired: "You must agree the privacy policy before submitting.",
  ...
  loginUsernameRequired: "The username is required.",
