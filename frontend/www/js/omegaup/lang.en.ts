...
const translations: { [key: string]: string; } = {
  ...
  courseCardDescriptionCourses: "Description:<br><br>The courses at omegaUp are for<br><br>- Teachers who want to create online courses<br><br>- Students participating in the courses of their classes<br><br>- Any user who wants to learn more about programming by participating in public courses",
