...
const translations: { [key: string]: string; } = {
  ...
  courseAssignmentEndDateBeforeCourseStartDate: "The assignment end date is previous to the course start date",
  ...
  courseAssignmentNewFormShortTitleAliasDesc: "The alias is used to construct the assignment URL (examples: HOMEWORK1, FINALTEST)",
  ...
  courseCardDescriptionCourses: "<p>The courses at omegaUp are for</p><ul><li>Teachers who want to create online courses</li><li>Students participating in the courses of their classes</li><li>Any user who wants to learn more about programming by participating in public courses</li></ul>",
  ...
  privacyPolicyNoticeDeprecated: "By clicking on Register you are accepting the site's <a href=\"http://blog.omegaup.com/privacy-policy/\">Use and Privacy Policy</a>, as well as our <a href=\"https://blog.omegaup.com/codigo-de-conducta-en-omegaup/\">Code of Conduct</a>.",
  ...
  problemCollectionRandomProblem: "Random Problem",
  ...
  studentProgressDescription: "%(progress)% (%(score) points)",
  studentProgressDescriptionTotalPoints: "(%(points) points)",
  studentProgressOnlyLecturesDescription: "This assignment only includes lectures",
