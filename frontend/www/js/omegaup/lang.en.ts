...
const translations: { [key: string]: string; } = {
  ...
  carouselSlideMentorsDescription: "omegaUp offers coders of the month the opportunity to receive personalized mentoring from internationally experienced volunteer software engineers working at the world's leading technology companies",
  carouselSlideMentorsTitle: "Mentors",
  carouselSlideSchoolsDescription: "Create your own courses with homework and exams and teach your students algorithmic thinking while having fun using omegaUp",
  carouselSlideSchoolsTitle: "omegaUp Schools",
  carouselSlideWelcomeDescription: "omegaUp is an open source platform for learning and improving your Computer Science skills through coding challenges with a fun and competitive approach",
  carouselSlideWelcomeTitle: "Welcome",
