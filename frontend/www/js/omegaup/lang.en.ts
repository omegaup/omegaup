...
const translations: { [key: string]: string; } = {
  ...
  certificatePdfCoderOfTheMonthDescription: "for the performance in the month of %s by obtaining the highest score on the omegaUp.com platform",
  certificatePdfCoderOfTheMonthFemaleTitle: "Coder of the month for her",
  certificatePdfCoderOfTheMonthTitle: "Coder of the month",
  certificatePdfContestDescription: "for the participation in the %s contest held on the omegaUp.com platform",
  ...
  certificatePdfPlaceAndDate: "Bellevue, Washington on %d %s %d",
  ...
  joinContestInteractiveGuideContestList: "Here, you'll see the contests that meet your requirements, click 'enroll' to register for the contest you desire.",
  joinContestInteractiveGuideFilter: "You can also filter by all contests, those you participate in, or recommended ones.",
  joinContestInteractiveGuideSearch: "You can search by name or keyword.",
  joinContestInteractiveGuideSort: "Sort by end date, name, duration, organizer, contestants, or whether you're registered.",
  joinContestInteractiveGuideTime: "Select the contest timeframe: current, past, or upcoming contests.",
  joinContestInteractiveGuideTimeCurrent: "Current: Contests that are active right now",
  joinContestInteractiveGuideTimeFuture: "Future: Contests to come",
  joinContestInteractiveGuideTimePast: "Past: Contests that are no longer active",
  joinContestInteractiveGuideTitle: "Join a Contest",
  joinContestInteractiveGuideWelcome: "Let's enroll in a contest",
  ...
  scoreboardNameAndAccountName: "Name and user",
