...
const translations: { [key: string]: string; } = {
  ...
  accountDeletionConfirmEmailBody: "El usuario %(username) confirmado para eliminar su cuenta.",
  accountDeletionConfirmEmailSubject: "borrar cuenta confimar",
  accountDeletionRequestEmailBody: "El usuario %(username) ha solicitado borrar su cuenta.",
  accountDeletionRequestEmailSubject: "Solicitud de eliminaci\u00f3n de cuenta",
