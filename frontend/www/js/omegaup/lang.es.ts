...
const translations: { [key: string]: string; } = {
  ...
  assignmentCardGoToContent: "Ir al contenido",
  ...
  problemCreatorAutomaticPoints: "Calcular puntaje autom\u00e1ticamente (avanzado)",
  ...
  problemCreatorAutomaticPointsHelperGroup: "El programa calcular\u00e1 el valor de este caso mediante esta f\u00f3rmula: (100 - (suma de los grupos que tienen puntaje explicito)) / (n\u00famero de grupos sin puntaje explicito)",
