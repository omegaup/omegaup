...
const translations: { [key: string]: string; } = {
  ...
  bulkUserAddError: "Se ha producido un error al agregar usuarios, <b>%(userEmail)</b> no se agreg\u00f3 correctamente porque no existe.",
  ...
  coderOfTheMonthFemaleNotice: "\u00a1Hola %(username)! \u00a1Felicidades por ser la ganadora La Coder del Mes! Tenemos un premio para t\u00ed, por favor cont\u00e1ctanos en mentores@omegaup.org",
