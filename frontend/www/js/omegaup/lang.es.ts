...
const translations: { [key: string]: string; } = {
  ...
  contestNewFormAdmissionModeDescription: "Selecciona el modo de acceso del concurso. Existen tres modalidades distintas:<br /><ul><li>Privado: El concurso solo es visible para coders que hayan sido invitados expl\u00edcitamente.</li><li>Registro/abierto: Cualquier persona se puede registrar, s\u00f3lo tienen acceso las personas admitidas por admins.</li><li>P\u00fablico: Cualquier persona puede participar.</li></ul>",
  ...
  courseEditAdmissionModeDescription: "Manual: Solo pueden inscribirse estudiantes que sean expl\u00edcitamente invitados.\nCompartir URL: Cualquiera con el link puede solicitar inscribirse. Adicionalmente, puedes agregar de forma manual los nombres de las cuentas de cada estudiante.",
  ...
  wordsAccountName: "Nombre de la cuenta",
