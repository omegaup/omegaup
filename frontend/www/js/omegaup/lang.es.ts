...
const translations: { [key: string]: string; } = {
  ...
  registrationRejectionFeedback: "La raz\u00f3n proporcionada por admin fue: %(extra_note)",
  ...
  submitFeedbackPlaceholder: "Ingresa tus comentarios (opcionalmente en blanco)",
  submitFeedbackRequireConfirmation: "Env\u00ede sus comentarios",
