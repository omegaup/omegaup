...
const translations: { [key: string]: string; } = {
  ...
  admissionModePublic: "P\u00fablico (Los estudiantes se inscriben desde la lista de cursos p\u00fablicos solamente si el curso es configurado como recomendado)",
  ...
  courseEditRequestSetRecommendedCourse: "Si est\u00e1s interesado en tener tu curso en la lista de cursos p\u00fablicos, por favor contacta a [hello@omegaup.com](mailto:hello@omegaup.com) indicando el alias del curso para someterlo a revisi\u00f3n.",
