...
const translations: { [key: string]: string; } = {
  ...
  badge_introToAlgorithmsCourseGraduate_description: "El usuario ha resuelto m\u00e1s del 70% del curso de Introducci\u00f3n a Algoritmos.",
  badge_introToAlgorithmsCourseGraduate_name: "Graduado del Curso de Introducci\u00f3n a Algoritmos",
