...
const translations: { [key: string]: string; } = {
  U13HasNotBeenVerifiedForTheirParent: "Esta es una cuenta para menores y no ha sido verificada por su figura parental. La cuenta se bloquear\u00e1 y no podr\u00e1 acceder al contenido.",
  ...
  accountVerifyWarning: "Su figura parental debe aprobar la cuenta, de lo contrario se eliminar\u00e1 en %(days) d\u00edas",
