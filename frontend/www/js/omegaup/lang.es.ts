...
const translations: { [key: string]: string; } = {
  ...
  notificationContestRegisterRequest: "Un nuevo parcipante: %(username) ha requerido registrarse para el concurso %(contestTitle) que t\u00fa manejas.",
  notificationContestRegisterationAccepted: "Tu solicitud de registro para el concurso %(contestTitle) ha sido **aceptada**.",
  notificationContestRegisterationRejected: "Tu solicitud de registro para el concurso %(contestTitle) ha sido **rechazada**.",
