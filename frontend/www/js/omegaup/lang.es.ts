...
const translations: { [key: string]: string; } = {
  ...
  courseAssignmentAdded: "Se agreg\u00f3 existosamente!",
  ...
  courseAssignmentNewFormShortTitle_alias_Desc: "El alias es usado para construir el URL del contenido (ejemplos: TAREA-SEMANA1, EXAMENFINAL)",
