...
const translations: { [key: string]: string; } = {
  ...
  courseAssignmentNewFormShortTitleAliasDesc: "El alias es usado para construir el URL de la tarea (examples: HOMEWORK1, FINALTEST)",
  ...
  courseCardDescriptionCourses: "<p>Los cursos en omegaUp son para<p><ul><li>Docentes que desean crear cursos en l\u00ednea</li><li>Estudiantes que participan en los cursos de sus clases</li><li>Cualquier persona que desea aprender m\u00e1s sobre programaci\u00f3n participando en los cursos p\u00fablicos</li></ul>",
  ...
  privacyPolicyNotice: "Al dar click en Registrar aceptas las [Pol\u00edticas de Uso y Privacidad](http://blog.omegaup.com/privacy-policy/) del sitio, as\u00ed como el [C\u00f3digo de Conducta](https://blog.omegaup.com/codigo-de-conducta-en-omegaup/).",
  privacyPolicyNoticeDeprecated: "Al dar click en Registrar aceptas las <a href=\"http://blog.omegaup.com/privacy-policy/\">Pol\u00edticas de Uso y Privacidad</a> del sitio, as\u00ed como el <a href=\"https://blog.omegaup.com/codigo-de-conducta-en-omegaup/\">C\u00f3digo de Conducta</a>.",
