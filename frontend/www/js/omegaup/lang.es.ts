...
const translations: { [key: string]: string; } = {
  ...
  contestNewFormPartialScoreDesc: "El puntaje de los env\u00edos se calcular\u00e1 de acuerdo a la suma de cada caso con veredicto AC. De lo contrario, la puntuaci\u00f3n ser\u00e1 0 en caso de que al menos un caso sea incorrecto",
  ...
  courseEditAdmissionModeDescription: "Selecciona el modo de acceso del curso. Existen dos opciones:<br /><ul><li>Privado: El curso no aparece en ninguna lista y los usuarios no pueden acceder a \u00e9l a menos que hayan sido invitados expl\u00edcitamente.</li><li>Registro/abierto: Cualquiera puede participar despu\u00e9s de haberse registrado, pero s\u00f3lo las personas previamente admitidas pueden participar oficialmente en el curso.</li></ul>",
