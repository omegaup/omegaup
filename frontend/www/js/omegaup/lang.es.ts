...
const translations: { [key: string]: string; } = {
  ...
  contestNewFormAdmissionModeDescription: "Selecciona el modo de acceso del concurso. Existen tres modalidades distintas:<br /><ul><li><b>Privado:</b> El concurso no sale en ninguna lista y los usuarios no pueden acceder a \u00e9l a menos que hayan sido invitados expl\u00edcitamente.</li><li><b>Registro/abierto:</b> Cualquiera puede participar despu\u00e9s de haberse registrado, pero s\u00f3lo las personas previamente admitidas pueden participar oficialmente en el concurso.</li><li><b>P\u00fablico:</b> Todos pueden participar.</li></ul>",
