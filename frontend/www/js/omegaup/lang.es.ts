...
const translations: { [key: string]: string; } = {
  ...
  privacyPolicyNotAccepted: "Lea y acepte la [Pol\u00edtica de uso y privacidad] del sitio (http://blog.omegaup.com/privacy-policy/), as\u00ed como el [C\u00f3digo de conducta](https://blog.omegaup.com/codigo -de-conducta-en-omegaup/).",
