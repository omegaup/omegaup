...
const translations: { [key: string]: string; } = {
  ...
  certificateDetailsBody: "Favor de escribirnos a <a href=\"mailto:certificados@omegaup.com?subject=Validar certificado %(uuid)\" target=\"blank\">certificados@omegaup.com</a> para verificar el certificado. Incluye el ID del certificado (%(uuid)) en el asunto del correo.",
