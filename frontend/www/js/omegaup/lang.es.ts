...
const translations: { [key: string]: string; } = {
  ...
  submissionFeedbackAddFinishComment: "Agrega un comentario para finalizar la revisi\u00f3n",
  submissionFeedbackAlreadyExists: "Ya existe retroalimentaci\u00f3n para este env\u00edo.",
  submissionFeedbackFinsihReview: "Finaliza la revisi\u00f3n de la presentaci\u00f3n",
