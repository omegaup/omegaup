...
const translations: { [key: string]: string; } = {
  ...
  token_corrupted: "Hubo un problema al decodificar el token.",
  token_expired: "El token que intentas utilizar ha expirado.",
  token_invalid: "El token no es v\u00e1lido para este curso.",
