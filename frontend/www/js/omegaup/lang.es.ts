...
const translations: { [key: string]: string; } = {
  ...
  arenaNameAndUsername: "Nombre y nombre de la cuenta",
  ...
  banningProblemDueToReport: "Suspendiendo problema por reporte de un coder.",
  ...
  contestNewFormForTeamsDesc: "Si est\u00e1 activado, s\u00f3lo pueden acceder equipos en lugar de identidades. Los equipos deben agregarse a un grupo de equipos.",
  ...
  courseEditAddAdminsTooltip: "Agrega administradores utilizando su nombre de cuenta de omegaUp",
  ...
  courseEditAdmissionModeDescription: "Manual: Los estudiantes no pueden inscribirse a menos que sean expl\u00edcitamente invitados.\nCompartir URL: Cualquiera con el link puede solicitar inscribirse. Adicionalmente, puedes agregar de forma manual los nombres de las cuentas de los estudiantes.",
  ...
  invalidUser: "Nombre de la cuenta no v\u00e1lido.",
  ...
  loginDisabled: "Tu cuenta es muy vieja y por tu seguridad ha sido deshabilitado. Para logguearte de nuevo contacta a omegaup-soporte@googlegroups.com",
  loginEmail: "E-mail",
  ...
  parameterUsernameInUse: "El nombre de cuenta ya fue tomado",
  ...
  profile: "Nombre",
  profileAddIdentitiesTooltip: "Agrega identidades utilizando el nombre de su cuenta de omegaUp",
  ...
  userOrMailNotFound: "Nombre de cuenta o mail no encontrado",
