...
const translations: { [key: string]: string; } = {
  ...
  courseCardDescriptionCourses: "<p>Descripci\u00f3n:</p><p>Los cursos en omegaUp son para<p><ul><li>- Profesores que desean crear cursos en l\u00ednea</li><li>- Alumnos que participan en los cursos de sus clases</li><li>- Cualquier usuario que desea aprender m\u00e1s sobre programaci\u00f3n participando en los cursos p\u00fablicos</li></ul>",
  ...
  courseEditAdmissionModeDescription: "Selecciona el modo de acceso del curso. Existen dos opciones:<br /><ul><li>Manual: Los estudiantes no pueden inscribirse a menos que sean expl\u00edcitamente invitados.</li><li>Compartir URL: Cualquiera con el link puede solicitar inscribirse. Adicionalmente, puedes agregar de forma manual los nombres de usuario de los estudiantes.</li></ul>",
