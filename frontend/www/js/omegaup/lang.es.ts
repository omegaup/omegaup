...
const translations: { [key: string]: string; } = {
  ...
  joinContestInteractiveGuideContestList: "Aqu\u00ed ver\u00e1s los concursos que cumplen con tus requisitos. Haz clic en 'inscribirse' para registrarte en el concurso que deseas.",
  joinContestInteractiveGuideFilter: "Tambi\u00e9n puedes filtrar por todos los concursos, aquellos en los que participas o los recomendados.",
  joinContestInteractiveGuideSearch: "Puedes buscar por nombre o palabra clave.",
  joinContestInteractiveGuideSort: "Ordenar por fecha de finalizaci\u00f3n, nombre, duraci\u00f3n, organizador, concursantes o si est\u00e1s registrado.",
  joinContestInteractiveGuideTime: "Selecciona el per\u00edodo del concurso: concursos actuales, pasados \u200b\u200bo pr\u00f3ximos.",
  joinContestInteractiveGuideTimeCurrent: "Actuales: Los concursos que est\u00e1n activos en este momento.",
  joinContestInteractiveGuideTimeFuture: "Futuros: Los concursos por venir.",
  joinContestInteractiveGuideTimePast: "Pasados: Los concursos que ya no est\u00e1n activos.",
  joinContestInteractiveGuideTitle: "Unirse a un concurso",
  joinContestInteractiveGuideWelcome: "Vamos a inscribirnos en un concurso",
  ...
  signUpFormInteractiveGuideUsername: "Elige tu nombre de usuario, S\u00f3lo se permiten letras may\u00fasculas, min\u00fasculas, n\u00fameros y los caracteres _, . y -, el m\u00ednimo de caracteres es 2.",
