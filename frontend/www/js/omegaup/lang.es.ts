...
const translations: { [key: string]: string; } = {
  ...
  contestAdmissionModeDescription: "Selecciona el modo de acceso del concurso. Existen tres modalidades distintas:- *Privado:* El concurso no sale en ninguna lista y los usuarios no pueden acceder a \u00e9l a menos que hayan sido invitados expl\u00edcitamente.\n\n- *Registro/abierto:* Cualquiera puede participar despu\u00e9s de haberse registrado, pero s\u00f3lo las personas previamente admitidas pueden participar oficialmente en el concurso.\n\n- *P\u00fablico:* Todos pueden participar.",
  ...
  courseBasicInformationNeeded: "Para unirte al curso debes completar tu informaci\u00f3n b\u00e1sica. Ir a [Mi perfil](/profile/edit/)",
  ...
  studentProgressDescription: "Puntaje: %(score) de %(points) puntos posibles.  Progreso: %(progress)%",
  studentProgressOnlyLecturesDescription: "Esta tarea s\u00f3lo incluye lecturas",
  studentProgressTooltipDescription: "Problema: %(problem)  Puntaje: %(score) de %(points) puntos posibles.  Progreso: %(progress)%",
