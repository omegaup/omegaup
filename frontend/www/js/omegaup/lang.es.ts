...
const translations: { [key: string]: string; } = {
  ...
  parameterInvalidStateDoesNotBelongToCountry: "El estado seleccionado no pertenece al pa\u00eds.",
  parameterInvalidStateNeedsBelongToCountry: "Debes seleccionar el pa\u00eds para elegir un estado.",
