...
const translations: { [key: string]: string; } = {
  ...
  studentProgressDescription: "Puntaje: %(score) de %(points) puntos posibles.<br />Progreso: %(progress)%",
  studentProgressTooltipDescription: "Problema: %(problem)<br />Puntaje: %(score) de %(points) puntos posibles.<br />Progreso: %(progress)%",
