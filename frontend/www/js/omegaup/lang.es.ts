...
const translations: { [key: string]: string; } = {
  ...
  carouselSlideMentorsDescription: "omegaUp ofrece a los coders del mes la posibilidad de recibir mentor\u00eda personalizada de ingenieros de software voluntarios con experiencia internacional que laboran en las principales empresas de tecnolog\u00eda del mundo",
  carouselSlideMentorsTitle: "Mentores",
  carouselSlideSchoolsDescription: "Crea tus propios cursos con tareas y ex\u00e1menes y ense\u00f1a a tus estudiantes pensamiento algor\u00edtmico mientras se divierten utilizando omegaUp",
  carouselSlideSchoolsTitle: "Escuelas en omegaUp",
  carouselSlideWelcomeDescription: "omegaUp es una plataforma de c\u00f3digo abierto para aprender y mejorar tus habilidades en Ciencias de la Computaci\u00f3n a trav\u00e9s de retos y competencias",
  carouselSlideWelcomeTitle: "Bienvenido",
  ...
  problemEditChooseVersion: "Versi\u00f3n",
