...
const translations: { [key: string]: string; } = {
  ...
  contestNewFormImmediatePartialFeedbackDesc: "Despu\u00e9s de evaluar cada env\u00edo se mostrar\u00e1 el resumen de los veredictos.",
  ...
  feedbackSubmissionContestSummary: "El procentaje de veredictos con AC en este env\u00edo es de <strong>%(pctAC)%</strong>.<br>El valor m\u00e1s bajo de veredictos en este env\u00edo ha sido <strong>%(worstSubmissionVerdict)</strong>.",
