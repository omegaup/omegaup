...
const translations: { [key: string]: string; } = {
  ...
  feedbackSubmissionContestSummary: "El puntaje de este env\u00edo es de <strong>%(points)</strong>.<br>El valor m\u00e1s bajo de veredictos en este env\u00edo ha sido <strong>%(worstSubmissionVerdict)</strong>.",
