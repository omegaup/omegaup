...
const translations: { [key: string]: string; } = {
  ...
  activityReportDuplicatesForOriginsDescription: "Or\u00edgenes con m\u00e1s de un coder",
  activityReportDuplicatesForUsersDescription: "Coders con m\u00e1s de una direcci\u00f3n",
  activityReportEvent: "Evento",
  activityReportNoDuplicatesForOrigins: "No hay or\u00edgenes con m\u00e1s de un coder",
  activityReportNoDuplicatesForUsers: "No hay coders con m\u00e1s de una direcci\u00f3n",
  ...
  addUsersMultipleOrSingleUser: "Agregar uno o m\u00faltiples coders",
  addUsersToReviewerGroup: "Clic para agregar un coder a la lista de revisores.",
  ...
  admissionModeManualOnly: "Manual (Agrega los nombres de coder de tus estudiantes)",
  ...
  banningProblemDueToReport: "Suspendiendo problema por reporte de coder.",
  birthdayInTheFuture: "No tienes edad suficiente para usar omegaUp",
  bulkOperationError: "Hubo un error al ejecutar la operaci\u00f3n",
  bulkUserAddError: "Se produjo un error al agregar coders. Los siguientes nombres de coder o correos electr\u00f3nicos no se encontraron en omegaUp:<br><br><b>%(userEmail)</b>.<br><br>Sin embargo, el resto de coders se han agregado correctamente.",
  bulkUserAddSuccess: "Coders exitosamente agregados.",
  ...
  contestInformationNotRequired: "La informaci\u00f3n de coder para este concurso no fue requerida.",
  ...
  contestNewFormAdmissionModeDescription: "Selecciona el modo de acceso del concurso. Existen tres modalidades distintas:<br /><ul><li>Privado: El concurso no sale en ninguna lista y los coders no pueden acceder a \u00e9l a menos que hayan sido invitados expl\u00edcitamente.</li><li>Registro/abierto: Cualquiera puede participar despu\u00e9s de haberse registrado, pero s\u00f3lo las personas previamente admitidas pueden participar oficialmente en el concurso.</li><li>P\u00fablico: Todos pueden participar.</li></ul>",
  ...
  contestNewFormForTeamsDesc: "Si est\u00e1 activado, s\u00f3lo pueden acceder equipos en lugar de coders o identidades. Los equipos deben agregarse a un grupo de equipos.",
  ...
  contestNewFormNoPenalty: "Coders con el mismo puntaje quedar\u00e1n empatados, sin importar el tiempo que le haya tomado a cada uno.",
  ...
  contestNewFormUserInformationRequiredDesc: "Elige \"Opcional\" si deseas solicitar permiso a los coders para compartir su informaci\u00f3n. Ellos pueden entonces decidir si la comparten o no, y podr\u00e1n participar en el concurso independientemente. Si no puedes permitir el acceso sin que compartan su informaci\u00f3n, elige \"Requerido\", pero toma en cuenta que algunos coders simplemente optar\u00e1n por no participar.",
  ...
  contestRegistrationPreAcceptedDescription: "El coder ha sido invitado expl\u00edcitamente al concurso",
  ...
  contestReportUsername: "Nombre de coder: %(username)",
  ...
  courseCardsListShowPastCourses: "Mostrar cursos pasados",
  courseCloneCreatedBy: "Creado por",
  courseCloneGenerateLinkButton: "Generar liga",
  courseCloneGenerateLinkDescription: "Cualquier coder con quien compartas esta liga podr\u00e1 usarla para clonar el curso por un periodo de 7 d\u00edas",
  ...
  courseDoesNotAdmitRegistration: "El curso no admite registro de coders",
  ...
  courseEditAddAdminsTooltip: "Agrega administradores utilizando su nombre de coder de omegaUp",
  ...
  courseEditAdmissionModeDescription: "Manual: Los estudiantes no pueden inscribirse a menos que sean expl\u00edcitamente invitados.\nCompartir URL: Cualquiera con el link puede solicitar inscribirse. Adicionalmente, puedes agregar de forma manual los nombres de coder de los estudiantes.",
  ...
  courseListSubmissionsByGroup: "Env\u00edos realizados por coders de este curso",
  ...
  courseRegistrationPreAcceptedDescription: "El coder ha sido invitado expl\u00edcitamente al curso",
  ...
  identityAlreadyInUse: "La identidad ya est\u00e1 siendo utilizada por otro coder.",
  ...
  loginDisabled: "Tu coder es muy viejo y por tu seguridad ha sido deshabilitado. Para logguearte de nuevo contacta a omegaup-soporte@googlegroups.com",
  loginEmail: "E-mail",
  loginEmailUsername: "E-mail o coder",
  ...
  loginThroughThirdParty: "Tu coder fue creado mediante un login externo (Google, Facebook, etc.). Por favor inicia sesi\u00f3n usando el mismo m\u00e9todo para poder establecer una contrase\u00f1a.",
  ...
  mustLoginToFilterUsers: "Para filtrar los coders del ranking debes iniciar sesi\u00f3n.",
  ...
  mustUpdateBasicInfoToFilterUsers: "Para filtrar los coders del ranking debes actualizar tu informaci\u00f3n b\u00e1sica.",
  ...
  notificationCourseRegistrationRequest: "El coder **%(username)** ha solicitado acceso al curso %(courseName).",
  ...
  parameterUsernameInUse: "El nombre de coder ya fue tomado",
  ...
  problemCreatorNewProblem: "Crear Problema",
  ...
  problemEditFormAllowUserAddTags: "Mostrar los tags sugeridos por los coders para este problema",
  ...
  problemVersionUsername: "Nombre de coder",
  ...
  problemsetIdentityNotFound: "El coder o identidad no est\u00e1 asociado con el curso, concurso o tarea.",
  problemsetNotFound: "Conjunto de problemas no encontrado.",
  profile: "Nombre",
  profileAddIdentitiesTooltip: "Agrega identidades utilizando el nombre de coder de omegaUp",
  ...
  profileUsername: "Nombre de coder",
  ...
  singleUserAddSuccess: "Coder exitosamente agregado.",
  ...
  tagSourceVoted: "Etiqueta de los coders",
  ...
  teamMemberUsernameInUse: "Existe al menos un nombre de coder duplicado en los equipos del grupo. Por favor corrige la informaci\u00f3n.",
  ...
  unverifiedUser: "Coder no verificado.",
  ...
  userAlreadyAcceptedPrivacyPolicy: "El coder ya hab\u00eda aceptado la pol\u00edtica de privacidad",
  userAlreadyHasSelectedRole: "El coder ya cuenta con rol seleccionado",
  userBirthDate: "Fecha de nacimiento: %(birthDate)",
  userDoesNotHaveAnyPasswordChangeRequest: "El coder no ha realizado la solicitud de cambio de contrase\u00f1a en las \u00faltimas 24 horas.",
  ...
  userEndTimeUpdatedSuccessfully: "El tiempo de finalizaci\u00f3n del concurso para el coder se ha actualizado correctamente.",
  userGroups: "Grupos",
  userInformationIsPrivate: "La informaci\u00f3n de este coder es privada",
  ...
  userNotExist: "Coder no existe",
  userNotInListOfRequests: "Este coder no tiene una solicitud pendiente.",
  ...
  userOrMailNotFound: "Coder o mail no encontrado",
  userPasswordMustBeSame: "Los passwords nuevos deben ser iguales.",
  userProfileIsPrivate: "El perfil de este coder est\u00e1 marcado como privado; alguna informaci\u00f3n no se mostrar\u00e1",
  userRankOfTheMonthHeader: "Los mejores %(count) coders con mayor puntaje del mes",
  userRemoveSuccess: "Coder exitosamente eliminado.",
  userRoles: "Roles",
  userVerified: "El coder ha sido verificado",
  userVerify: "Verificar coder",
  username: "Coder",
  usernameInUse: "Este nombre de coder ya ha sido utilizado.",
  usernameOrPassIsWrong: "El nombre de coder o la contrase\u00f1a son incorrectos. Por favor verifica tus credenciales.",
  usersCanNotBeAddedInContestForTeams: "No se pueden agregar coders en concursos para equipos",
  ...
  wordsEmptyAddStudentInput: "El campo est\u00e1 vac\u00edo, por favor ingrese un nombre de coder",
  ...
  wordsMonths: "Meses",
  wordsMultipleUser: "M\u00faltiples coders (Separados por comas o nueva l\u00ednea)",
  ...
  wordsUser: "Coder",
  wordsUsersFeedback: "Opiniones de los coders",
