...
const translations: { [key: string]: string; } = {
  ...
  authorRankRangeHeader: "Top %(lowCount) a %(highCount) contribuidores con mayor puntaje",
  ...
  codersOfTheMonthListCandidate: "Lista de apirantes a coder del mes",
  ...
  rankRangeHeader: "Top %(lowCount) a %(highCount) coders con mayor puntaje",
  rankScore: "Score",
  ...
  wordsSeeLatestSubmissions: "Ver los \u00faltimos env\u00edos realizados por",
