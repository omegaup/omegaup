...
const translations: { [key: string]: string; } = {
  ...
  addContestUsernameAndPassword: "Si participaste en alg\u00fan concurso y te asignaron un usuario y una contrase\u00f1a, agregalo aqu\u00ed para vincularlo con tu cuenta principal.",
