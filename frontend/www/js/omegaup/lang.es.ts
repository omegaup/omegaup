...
const translations: { [key: string]: string; } = {
  ...
  problemCreatorAutomaticPointsHelper: "El programa calcular\u00e1 el valor de este caso mediante esta f\u00f3rmula: (100 - (suma de los casos que tienen puntaje explicito)) / (n\u00famero de casos sin puntaje explicito)",
