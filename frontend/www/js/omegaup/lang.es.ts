...
const translations: { [key: string]: string; } = {
  ...
  courseTabEnrolled: "Cursos que estudio",
  ...
  problemCreatorAllGroupCasesWillBeDeleted: "Todos los casos de este grupo ser\u00e1n eliminados",
  problemCreatorAutoPoints: "Puntaje Autom\u00e1tico",
  problemCreatorCancel: "Cancelar",
  problemCreatorCantUndo: "Esta acci\u00f3n no se puede deshacer",
  problemCreatorCase: "Caso",
  problemCreatorCaseName: "Nombre del caso",
  problemCreatorCaseNameHint: "En min\u00fasculas y sin espacios",
  problemCreatorCaseNumber: "N\u00famero de casos",
  problemCreatorCaseNumberHint: "Tus casos tendr\u00e1n el nombre de: ",
  problemCreatorCases: "Casos de Prueba",
  problemCreatorCreateProblem: "Generar Problema",
  problemCreatorDelete: "Borrar",
  problemCreatorDeleteAllCases: "Borrar todos los casos",
  problemCreatorDeleteGroup: "Eliminar Grupo",
  problemCreatorDeleteGroupCasesConfirmation: "\u00bfEst\u00e1s seguro que deseas borrar todos los casos?",
  problemCreatorDeleteGroupConfirmation: "\u00bfEst\u00e1s seguro que deseas borrar este grupo?",
  ...
  problemCreatorNamePlaceholder: "Nuevo Problema",
  problemCreatorNewProblem: "Crear Problema",
  problemCreatorNoGroup: "sin_grupo",
  problemCreatorPoints: "Puntaje",
  problemCreatorPointsHint: "El programa calcular\u00e1 autom\u00e1ticamente el puntaje",
  problemCreatorPrefix: "Prefijo",
  problemCreatorSolution: "Soluci\u00f3n",
  problemCreatorSuffix: "Sufijo",
  problemCreatorWriting: "Redacci\u00f3n",
