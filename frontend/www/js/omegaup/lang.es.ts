...
const translations: { [key: string]: string; } = {
  ...
  problemCreatorAutomaticPoints: "Puntaje autom\u00e1tico",
  problemCreatorAutomaticPointsHelper: "El programa calcular\u00e1 el valor de este caso dependiendo del n\u00famero de casos. Si hay 4 casos, el puntaje de cada uno ser\u00e1 25. (Los casos donde se les haya asignado manualmente el puntaje, no son tomados en cuenta dentro de este c\u00e1lculo)",
