...
const translations: { [key: string]: string; } = {
  ...
  certificateValidationEnteredCode: "C\u00f3digo ingresado: %(code)",
  certificateValidationInvalid: "INV\u00c1LIDO",
  certificateValidationNotFound: "No se encontr\u00f3 ning\u00fan diploma con el c\u00f3digo %(code) en la base de datos. Si usted cree que eso es un error por favor cont\u00e1ctenos en hello@omegaup.com.",
