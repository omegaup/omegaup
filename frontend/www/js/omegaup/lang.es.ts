...
const translations: { [key: string]: string; } = {
  ...
  courseCardDescriptionCourses: "<p>Los cursos en omegaUp son para<p><ul><li>Profesores que desean crear cursos en l\u00ednea</li><li>Alumnos que participan en los cursos de sus clases</li><li>Cualquier usuario que desea aprender m\u00e1s sobre programaci\u00f3n participando en los cursos p\u00fablicos</li></ul>",
