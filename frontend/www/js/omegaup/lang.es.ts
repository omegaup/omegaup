...
const translations: { [key: string]: string; } = {
  ...
  arenaContestPracticeOriginalRunsText: "Para ver los env\u00edos del concurso, da clic [aqu\u00ed](/arena/%(contestAlias)/admin/#runs)",
  ...
  coderOfTheMonthNotice: "\u00a1Hola %(username)! \u00a1Felicidades por ganar el reconocimiento al Coder del Mes! Tenemos un premio para ti, por favor cont\u00e1ctanos en mentores@omegaup.org",
  ...
  contestCanNotChangeToContestForTeams: "Un concurso normal no puede cambiar a concurso para equipos",
  ...
  contestForTeamsCanNotChangeToContest: "Un concurso para equipos no puede cambiar a concurso normal",
  ...
  feedbackTitle: "Retroalimentaci\u00f3n del profesor",
  ...
  loginThroughThirdParty: "Tu usuario fue creado mediante un login externo (Google, Facebook, LinkedIn, etc.). Por favor inicia sesi\u00f3n usando el mismo m\u00e9todo para poder establecer una contrase\u00f1a.",
  ...
  scoreboardShowOnlyInvitedIdentities: "Mostrar s\u00f3lo concursantes invitados",
  ...
  submissionFeedbackSendButton: "Dejar retroalimentaci\u00f3n para el estudiante \ud83d\udd3d",
  submissionFeedbackUpdateButton: "Actualizar retroalimentaci\u00f3n para el estudiante \ud83d\udd3d",
