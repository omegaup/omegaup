...
const translations: { [key: string]: string; } = {
  ...
  loginEmailRequired: "El correo electr\u00f3nico es requerido.",
  ...
  loginParentEmailRequired: "El correo electr\u00f3nico de la figura parental es requerido.",
  loginPassword: "Contrase\u00f1a",
  loginPasswordCreate: "Contrase\u00f1a (Min. 8 caracteres)",
  loginPasswordTooShort: "La contrase\u00f1a es muy corta.",
  loginPrivacyPolicyRequired: "Debes aceptar las pol\u00edticas de privacidad antes de enviar el formulario.",
  ...
  loginUsernameRequired: "El nombre de usuario es requerido.",
