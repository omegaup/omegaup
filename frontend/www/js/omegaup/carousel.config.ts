const carouselConfig: {
  ...
  },
  {
    ...
    "description": {
        ...
        "es": "¿Te gustaría aprender a programar? Apúntate al curso de Introducción a C++ en omegaUp. Consta de lecciones, ejemplos y problemas repartidos en 7 módulos.",
        "pt": "Deseja aprender a programar? Participe do curso Introdução ao C ++ no omegaUp. Consiste em lições, exemplos e problemas espalhados por 7 módulos"
    },
    "button": {
      "text": {
        "en": "Enter here",
