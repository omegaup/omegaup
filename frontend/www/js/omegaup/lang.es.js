...
const translations = {
	...
	solutionTokenDescription: "Recuerda que recibes un token por cada diez problemas resueltos. Una vez que decides desbloquear la soluci\u00f3n de un problema, \u00e9ste dejar\u00e1 de contar en tu puntuaci\u00f3n para el ranking de omegaUp.",
	solutionTokens: "Tienes <b>%(available)</b> tokens disponibles, de un total de <b>%(total)</b> obtenido(s).",
