...
omegaup.T = {
	...
	contestNewFormDifferentStarts: "Tiempo (en minutos) que tienes para enviar soluciones después que el concurso inicia: %(window_length) minutos",
	...
	contestNewFormPenaltyDesc: "Entero indicando el número de minutos con que se penaliza por enviar una respuesta incorrecta: %(window_length) minutos",
	...
	contestNewFormScoreboardTimePercent: "Porcentaje del tiempo total del concurso en el que la tabla de puntuaciones se puede observar: %(window_length)%",
	...
	contestNewFormSubmissionsSeparationDesc: "Tiempo mínimo que debe de esperar un concursante despues de realizar un envío para hacer otro: %(window_length) minutos.",
