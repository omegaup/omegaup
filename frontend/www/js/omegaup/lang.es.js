...
const translations = {
	...
	clockDays: "%(days) d\u00edas, ",
	clockHour: "%(hour) hora, ",
	clockHours: "%(hours) horas, ",
	clockMinute: "%(minute) minuto, ",
	clockMinutes: "%(minutes) minutos, ",
	clockMonth: "%(month) mes, ",
	clockMonths: "%(months) meses, ",
	clockSecond: "%(second) segundo.",
	clockSeconds: "%(seconds) segundos.",
	clockYear: "%(year) a\u00f1o, ",
	clockYears: "%(years) a\u00f1os, ",
	...
	wordsHours: "horas",
	wordsHumanReadable: "Legible por humanos",
	wordsID: "ID",
