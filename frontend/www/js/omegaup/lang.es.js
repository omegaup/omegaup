...
const translations = {
	...
	contestIntroDifferentStarts: "Una vez iniciado el concurso, su duraci\u00f3n es de %(window_length_hr)h%(window_length_min)m.",
	contestIntroPenaltyDesc: "Se penalizar\u00e1 con un tiempo de %(window_length_hr)h%(window_length_min)m cada env\u00edo incorrecto.",
	contestIntroScoreboardTimePercent: "El scoreboard en vivo se mostrar\u00e1 al inicio y hasta %(window_length_hr)h%(window_length_min)m despu\u00e9s.",
	...
	contestIntroSubmissionsSeparationDesc: "Por cada env\u00edo incorrecto se deber\u00e1 esperar %(window_length_hr)h%(window_length_min)m para hacer un nuevo env\u00edo.",
