...
omegaup.OmegaUp.loadTranslations({
	...
	demotionProblemEmailBody: "Estimado <strong>%1$s</strong>:<br><br>El acceso a tu problema <strong>%2$s</strong> en omegaup.com ha sido restringido debido a que ha sido reportado como un problema inapropiado. El equipo de omegaUp revis\u00f3 este reporte y confirm\u00f3 que el problema no es apropiado debido a que <em>%3$s<em>.<br><br><br>Para desbloquear el problema y que vuelva a mostrarse en la lista de problemas, por favor sigue los siguientes pasos:<br><br>Revisa y edita tu problema, asegurate que describa un problema, no sea ofensivo ni spam.<br>Una vez que hayas resuelto la raz\u00f3n por la que tu problema fue bloqueado, manda un email a <a href='mailto:omegaup@omegaup.com' target='_top'>omegaup@omegaup.com</a> para que sea revisado y reactivado.<br><br>De no seguirse los pasos mencionados arriba, el problema no se volver\u00e1 a mostrar en la lista de problemas ni se podr\u00e1 utilizar en concursos. En caso de reincidir 3 veces, omegaUp se reserva el derecho de suspender tu cuenta de usuario.<br><br>omegaUp es una plataforma para ayudar a los usuarios a mejorar sus habilidades en ingenier\u00eda de software resolviendo problemas de c\u00f3digo y compitiendo en concursos de programaci\u00f3n. omegaUp da la bienvenida a todos los problemas que ayuden a cumplir esa meta.<br><br>Gracias,<br>Equipo omegaUp",
	demotionProblemEmailSubject: "El problema %1$s ha sido reportado como inapropiado",
