    ...
    <div class="card-body">
      ...
      <div>
        ...
        <ul>
          ...
          <li v-if="scoreboardDescription !== ''">{{ scoreboardDescription }}</li>
          <li v-if="contest.submissions_gap !== 0">{{ submissionsGapDescription }}</li>
          <li v-if="contest.penalty_type !== 'none'">{{ penaltyTypes[contest.penalty_type] }}</li>
          <li v-if="contest.penalty !== 0">{{ penaltyDescription }}</li>
          <li v-if="contest.feedback !== 'none'">{{ feedbackTypes[contest.feedback] }}</li>
