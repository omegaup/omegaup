<template>
      ...
      <div class="tab-content mt-2">
        <div v-if="showTab === 'course'" class="tab-pane active" role="tabpanel">
          <omegaup-course-form
            ...
            @update-search-result-schools="(query) => $emit('update-search-result-schools', query)"
          ></omegaup-course-form>
        </div>
  ...
  export default class CourseEdit extends Vue {
    ...
    assignmentFormMode: omegaup.AssignmentFormMode = omegaup.AssignmentFormMode.Default;
    ...
    if (!request.school) {
      ...
      // Update the global status element (already done)
      ...
      if (schoolInput) {
        schoolInput.style.border = '2px solid red';
      }
