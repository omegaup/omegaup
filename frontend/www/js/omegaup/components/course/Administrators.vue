        ...
        <div class="col-md-6">
          ...
          <table class="table table-striped table-over" v-else="">
            ...
            <tbody>
              ...
              >
                <td>
                  <a v-bind:href="adminProfile(admin)">{{
                ...
                <td>
                  <button
                    ...
                    v-on:click="$emit('removeAdmin', admin)"
                  >
                    ×
                  </button>
                </td>
              ...
              <tr v-for="group in groupadmins">
                ...
                <td>
                  <button
                    class="close"
                    type="button"
                    v-on:click="$emit('removeGroupAdmin', group)"
                  >
                    ×
                  </button>
                </td>
