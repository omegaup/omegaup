  ...
  <div>
    <div class="d-flex align-items-center justify-content-between">
      ...
      <div>
        ...
        <b-sidebar v-model="showLayoutSidebar" right title="Layouts" shadow no-header-close width="385px">
      ...
      <b-card class="border-0">
        ...
        <b-row v-for="{ name, groupID, cases, points } in groupsButUngroupedCases" :key="groupID" class="mb-1">
          ...
          <b-dropdown variant="light" size="sm" right no-caret>
            ...
            <b-dropdown-item @click="deleteGroup(groupID)"><b-row>
                <div class="ml-6">
                  <BIconTrash variant="danger" font-scale=".95" />
                </div>
                <div class="ml-8">
            ...
            <b-dropdown-item @click="deleteGroupCases(groupID)"><b-row>
                <div class="ml-6">
                  <BIconTrash variant="danger" font-scale=".95" />
                </div>
                <div class="ml-8">
