...
export default class AddPanel extends Vue {
  ...
  addItemToStore() {
    ...
    if (this.tab === 'case') {
      ...
      if (caseGroup === NIL) {
        // In this case we just need to check if there is a group with the same name. Since every time a new ungrouped case is created, a coressponding group is created too
