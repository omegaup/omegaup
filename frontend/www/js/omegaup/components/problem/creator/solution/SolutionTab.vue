          ...
          steps: [
            {
              ...
              element: document.querySelector('[data-problem-creator-solution-previewer-markdown]') as HTMLElement | null,
            },
            {
              title: T.problemCreatorSolutionTabIntroEditorTitle,
              intro: T.problemCreatorSolutionTabIntroEditorIntro,
              element: document.querySelector('[data-problem-creator-solution-save-markdown]') as HTMLElement | null,
            },
            {
