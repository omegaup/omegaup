<template>
  <div>
    <a class="show-finder-button" v-on:click="showFinderWizard = true">Probar el buscador de problemas</a>
    <omegaup-problem-finder v-show="showFinderWizard" v-on:close="showFinderWizard = false"></omegaup-problem-finder>
