  ...
  <div class="card" data-user-rank>
    ...
    <div v-if="!isIndex" class="card-body">
      <div class="row mb-2">
        ...
        ></omegaup-common-typeahead>
        <button
          class="btn btn-primary form-control col-4 col-md-2 mr-0 me-md-2"
          type="button"
          @click="onSubmit"
        >
          {{ T.searchUser }}
      ...
      <table class="table mb-0 table-responsive-sm">
        <thead>
          <tr>
            ...
            <th scope="col" class="ps-4 column-collapse-horizontal align-middle">#</th>
        ...
        <tbody>
          <tr v-for="(user, index) in ranking" :key="index">
            ...
            <th scope="row" class="ps-4 column-collapse-horizontal">{{ user.rank }}</th>
