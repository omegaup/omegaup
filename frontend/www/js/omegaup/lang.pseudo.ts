...
const translations: { [key: string]: string; } = {
  ...
  notificationCourseRegistrationRequest: "(Th3 u53r <57r0ng>%(username)</57r0ng> ha5 r3qu3573d acc355 70 c0ur53 <a hr3f='%(courseLink)'>%(courseName)</a>.)",
  notificationNewBadge: "(Y0u hav3 r3c3iv3d a n3w badg3: <a hr3f='%(badgeLink)'>%(badgeName)</a>)",
