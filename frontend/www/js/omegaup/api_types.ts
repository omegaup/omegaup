...
export namespace types {
  export namespace payloadParsers {
   ...
   export function CarouselItemListPayload(elementId: string = 'payload'): types.CarouselItemListPayload {
     return ((x) => { x.carouselItems = ((x) => { if (!Array.isArray(x)) { return x; } return x.map((x) => { if (typeof x.expiration_date !== 'undefined' &&  x.expiration_date !== null) x.expiration_date = ((x: number) => new Date(x * 1000))(x.expiration_date); return x; }); })(x.carouselItems); return x; })(
       JSON.parse((document.getElementById(elementId) as HTMLElement).innerText),
     );
   ...
   export function UserComparePayload(elementId: string = 'payload'): types.UserComparePayload {
     return ((x) => { if (typeof x.user1 !== 'undefined' &&  x.user1 !== null) x.user1 = ((x) => { x.profile = ((x) => { if (typeof x.birth_date !== 'undefined' &&  x.birth_date !== null) x.birth_date = ((x: number) => new Date(x * 1000))(x.birth_date); if (typeof x.graduation_date !== 'undefined' &&  x.graduation_date !== null) x.graduation_date = ((x: number) => new Date(x * 1000))(x.graduation_date); return x; })(x.profile); return x; })(x.user1); if (typeof x.user2 !== 'undefined' &&  x.user2 !== null) x.user2 = ((x) => { x.profile = ((x) => { if (typeof x.birth_date !== 'undefined' &&  x.birth_date !== null) x.birth_date = ((x: number) => new Date(x * 1000))(x.birth_date); if (typeof x.graduation_date !== 'undefined' &&  x.graduation_date !== null) x.graduation_date = ((x: number) => new Date(x * 1000))(x.graduation_date); return x; })(x.profile); return x; })(x.user2); return x; })(
       JSON.parse((document.getElementById(elementId) as HTMLElement).innerText),
     );
  ...
  export interface BookmarkProblem { alias: string; title: string; };
  ...
  export interface CachedExtraProfileDetails { badges: string[]; bookmarkedProblems: types.BookmarkProblem[]; contests: types.UserProfileContests; createdContests: types.Contest[]; createdCourses: types.Course[]; createdProblems: types.Problem[]; solvedProblems: types.Problem[]; stats: types.UserProfileStats[]; unsolvedProblems: types.Problem[]; };

  export interface CarouselItem { button_title: string; carousel_item_id: number; excerpt: string; expiration_date?: Date; image_url: string; link: string; status: boolean; title: string; };

  export interface CarouselItemListPayload { carouselItems: types.CarouselItem[]; };
  ...
  export interface CommonPayload { apiTokens: types.ApiToken[]; associatedIdentities: types.AssociatedIdentity[]; currentEmail: string; currentName?: string; currentUsername: string; gravatarURL128: string; gravatarURL51: string; inContest: boolean; isAdmin: boolean; isLoggedIn: boolean; isMainUserIdentity: boolean; isReviewer: boolean; isUnder13User: boolean; lockDownImage: string; maintenanceMessage?: types.MaintenanceMessage; mentorCanChooseCoder: boolean; navbarSection: string; nextRegisteredContestForUser?: types.ContestListItem; omegaUpLockDown: boolean; preferredLanguage: string; profileProgress: number; userClassname: string; userCountry: string; userTypes: string[]; userVerificationDeadline?: Date; };
  ...
  export interface LoginDetailsPayload { facebookUrl?: string; githubClientId?: string; githubState?: string; hasVisitedSection?: boolean; statusError?: string; validateRecaptcha: boolean; verifyEmailSuccessfully?: string; };

  export interface MaintenanceMessage { message: string; type: string; };

  export interface MaintenanceModeStatus { enabled: boolean; message_en?: string; message_es?: string; message_pt?: string; type: string; };
  ...
  export interface MessageLanguages { en: string; es: string; pt: string; };
  ...
  export interface PredefinedTemplate { id: string; message: types.MessageLanguages; title: types.MessageLanguages; type: string; };
  ...
  export interface ProblemListPayload { column: string; columns: string[]; keyword: string; language: string; languages: string[]; loggedIn: boolean; mode: string; modes: string[]; notes: { [key: number]: string; }; pagerItems: types.PageItem[]; problems: types.ProblemListItem[]; selectedTags: string[]; tagData: { name?: string; }[]; tags: string[]; };
  ...
  export interface SupportDetailsPayload { maintenanceMode: types.MaintenanceModeStatus; maintenancePredefinedTemplates: types.PredefinedTemplate[]; roleNamesWithDescription: types.UserRole[]; };
  ...
  export interface UserCompareData { contestsCount?: number; profile: types.UserProfileInfo; solvedProblemsCount?: number; };

  export interface UserComparePayload { user1?: types.UserCompareData; user2?: types.UserCompareData; username1?: string; username2?: string; };
...
export namespace messages {
  ...
  export type ACLUserOwnedAclReportResponse = { acls: { acl_id: number; alias: string; type: string; users: { role_description: string; role_id: number; role_name: string; user_id: number; username: string; }[]; }[]; };
  ...
  export type ProblemBookmarkListResponse = { problems: types.BookmarkProblem[]; total: number; };
  ...
  export type ProblemNoteListResponse = { notes: types.ProblemNoteItem[]; total: number; };
  ...
  export type UserCompareResponse = { user1?: types.UserCompareData; user2?: types.UserCompareData; };
