$('document').ready(function() {
	...
	// Defaults for OMI
	$('#omi').click(function() {
		$(".new_contest_form #title").attr('placeholder', omegaup.T.contestNewFormTitlePlaceholderOmiStyle);
	...
	$('#preioi').click(function() {
		$(".new_contest_form #title").attr('placeholder', omegaup.T.contestNewFormTitlePlaceholderIoiStyle);
	...
	$('#conacup').click(function() {
		$(".new_contest_form #title").attr('placeholder', omegaup.T.contestNewFormTitlePlaceholderConacupStyle);
		$('#window_length_enabled').removeAttr('checked');
		$('#window_length').attr('disabled','disabled');
		$('#window_length').val('');
