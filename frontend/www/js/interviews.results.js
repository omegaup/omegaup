$(document).ready(function() {
	...
	omegaup.API.getInterviewStatsForUser(interviewAlias, candidateUsername, function(userStats) {
	...
	omegaup.API.getRuns({ username : candidateUsername, contest_alias : interviewAlias }, function(runs){
		console.log(runs)
	});
});
