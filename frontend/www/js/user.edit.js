omegaup.OmegaUp.on('ready', function() {
  ...
  $('#school')
    .typeahead({ minLength: 2, highlight: true }, {
      ...
      displayKey: 'label',
      templates: { empty: omegaup.T.schoolToBeAdded }
    })
  ...
  $('#country_id').change(function() {
    ...
    if ($('#country_id').val() == 'MX') {
      ...
      $('#state_id').append(
        $('<option></option>').attr('value', '52').text('Aguascalientes')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '53').text('Baja California')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '54').text('Baja California Sur')
      );
      $('#state_id').append(
      ...
      $('#state_id').append(
        $('<option></option>').attr('value', '60').text('Distrito Federal')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '61').text('Durango')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '62').text('Guanajuato')
      );
      $('#state_id').append(
      ...
      $('#state_id').append(
        $('<option></option>').attr('value', '70').text('Nuevo Leon')
      );
      $('#state_id').append(
      ...
      $('#state_id').append(
        $('<option></option>').attr('value', '74').text('Quintana Roo')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '75').text('San Luis Potosi')
      );
      $('#state_id').append(
      ...
      $('#state_id').append(
        $('<option></option>').attr('value', '79').text('Tamaulipas')
      );
      $('#state_id').append(
      ...
      $('#state_id').append(
        $('<option></option>').attr('value', '7').text('Connecticut')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '8').text('Delaware')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '9').text('District of Columbia')
      );
      $('#state_id').append(
      ...
      $('#state_id').append(
        $('<option></option>').attr('value', '22').text('Massachusetts')
      );
      $('#state_id').append(
      ...
      $('#state_id').append(
        $('<option></option>').attr('value', '25').text('Mississippi')
      );
      $('#state_id').append(
      ...
      $('#state_id').append(
        $('<option></option>').attr('value', '30').text('New Hampshire')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '31').text('New Jersey')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '32').text('New Mexico')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '33').text('New York')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '34').text('North Carolina')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '35').text('North Dakota')
      );
      $('#state_id').append(
      ...
      $('#state_id').append(
        $('<option></option>').attr('value', '39').text('Pennsylvania')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '40').text('Rhode Island')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '41').text('South Carolina')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '42').text('South Dakota')
      );
      $('#state_id').append(
      ...
      $('#state_id').append(
        $('<option></option>').attr('value', '48').text('Washington')
      );
      $('#state_id').append(
        $('<option></option>').attr('value', '49').text('West Virginia')
      );
      $('#state_id').append(
  ...
  omegaup.API.getProfile(null, function(data) {
    ...
    $('#recruitment_optin').prop(
      'checked',
      data.userinfo.recruitment_optin == 1
    );
