...
## Table of Contents ##
* [Project Ideas List](/docs/Google-Summer-of-Code-2018-Ideas-List#ideas-list.md)
* [How to Ramp Up](/docs/Google-Summer-of-Code-2018-Ideas-List#how-to-ramp-up.md)
* [Our Mailing List and Slack Channel](/docs/Google-Summer-of-Code-2018-Ideas-List#our-mailing-list-and-slack-channel.md)
* [How to Write Your Application](/docs/Google-Summer-of-Code-2018-Ideas-List#how-to-write-your-application.md)
* [FAQs](/docs/Google-Summer-of-Code-2018-Ideas-List#frequently-asked-questions.md)
...
* Follow these [instructions](/docs/How-to-Set-Up-Your-Development-Environment-(English.md)) to set up your development environment.
