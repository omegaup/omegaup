...
- [How to start developing](https://github.com/omegaup/omegaup/blob/main/frontend/www/docs/Development-Environment-Setup-Process.md) 
...
- [Monitoring tools](https://github.com/omegaup/omegaup/blob/main/frontend/www/docs/Monitoring-Tools.md)

- [Configure nginx](https://github.com/omegaup/omegaup/blob/main/frontend/www/docs/Configure-nginx.md)  

## Features on omegaup.com  
- [Guide for badge implementation](https://github.com/omegaup/omegaup/blob/main/frontend/www/docs/Guide-for-Badge-Implementation-in-omegaUp.md)

- [How to add notifications to the DB](https://github.com/omegaup/omegaup/blob/main/frontend/www/docs/How-to-add-new-notifications.md)
