...
We ask that you complete phase one before you start working with our codebase.
 ...
 - Follow these [instructions](/docs/Development-Environment-Setup-Process.md) to set up your development environment.
...
# Communications
## If you have questions about the [development evironment](/docs/Quiero-desarrollar-en-omegaUp.md) or the [codebase](https://github.com/omegaup/omegaup) or how the GSoC application process works at omegaUp, please follow our [Getting Help page](/docs/How-to-Get-Help.md) to effectively getting your question answered.
...
# Frequently Asked Questions #
   * **The development environment installation script is throwing me an error.** Please follow our [Getting Help page](/docs/How-to-Get-Help.md) to effectively getting your issue resolved.
