Arena (also known as Frontend for v1) won’t contain any logic for problem validation — that’s Grader’s job. Moreover, Grader can communicate with external judges!
