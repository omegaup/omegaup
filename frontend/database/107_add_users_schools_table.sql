...
DROP CONSTRAINT `fk_is_school_id`,
CHANGE COLUMN `school_id` `current_school_id` int(11) DEFAULT NULL,
ADD KEY `current_school_id` (`current_school_id`)
ADD CONSTRAINT `fk_is_school_id` FOREIGN KEY (`current_school_id`) REFERENCES `Schools` (`school_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
