...
-- Creating indexes on Problemset_Identities and synchronizing user - identity data
...
-- Creating indexes on Problemset_Identity_Request and synchronizing user - identity data
