...
CREATE TABLE `Contests` (
  ...
  `contestants` int NOT NULL DEFAULT '0',
  ...
  KEY `idx_archived_recommended_endcheck` (`archived`,`recommended`,`finish_time`,`start_time`),
  KEY `idx_admission_archived_recommended_endcheck` (`admission_mode`,`archived`,`recommended`,`finish_time`,`start_time`),
...
CREATE TABLE `Problemsets` (
  ...
  KEY `idx_pp_contest_problemset` (`contest_id`,`problemset_id`),
