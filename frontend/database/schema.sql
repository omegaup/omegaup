...
CREATE TABLE `Submissions` (
  ...
  KEY `idx_submissions_problemset_problem_status_type` (`problemset_id`,`problem_id`,`status`,`type`),
  KEY `idx_submissions_problemset_time` (`problemset_id`,`time` DESC),
  KEY `idx_submissions_problem_submission` (`problem_id`,`submission_id`),
  KEY `idx_submissions_identity_problemset_problem_type` (`identity_id`,`problemset_id`,`problem_id`,`type`),
