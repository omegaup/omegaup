...
--
-- Estructura de tabla para la tabla `QualityNominations`
--
...
--
-- Estructura de tabla para la tabla `QualityNomination_Reviewers`
--
...
--
-- Estructura de tabla para la tabla `QualityNomination_Comments`
--
...
ALTER TABLE `Courses`
  ...
  ADD CONSTRAINT `fk_g_admin_group_id` FOREIGN KEY (`group_id`) REFERENCES `Groups` (`group_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `QualityNominations`
--
...
--
-- Filtros para la tabla `QualityNominations_Reviewers`
--
...
--
-- Filtros para la tabla `QualityNominations_Comments`
--
