...
CREATE TABLE `Assignments` (
  ...
  KEY `idx_assignments_course_type` (`course_id`,`assignment_type`),
  KEY `idx_assignments_course_problemset` (`course_id`,`problemset_id`),
  KEY `idx_assignments_problemset_course` (`problemset_id`,`course_id`),
