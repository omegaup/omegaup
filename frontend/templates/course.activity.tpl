...
{include file='head.tpl' jsfile={version_hash src="/js/course.activity.js"} htmlTitle="{#contestActivityReport#}"}

<div class="post">
  <div class="copy">
    <h1><a href="/course/{$smarty.get.course|escape}/">
        {$smarty.get.course}</a> &mdash; {#contestActivityReport#}</h1>
