...
{block name="content"}
	...
	<legend>Nombre: <input id='name' name='name' value='' type='text' size='30'> </legend>
	<legend>Fecha de nacimiento: <input id='birth_date' name='birth_date' value='' type='text' size ='10'></legend>
	<legend>País: <select name='country_id' id='country_id'>
			<option value=""></option>
	...
	<input value='Guardar cambios' type='submit' class="OK">
