...
{/if}
		...
		<link rel="stylesheet" href="/third_party/js/intro.js/minified/introjs.min.css">
		<script type="text/javascript" src="{version_hash src="/third_party/js/intro.js/minified/intro.min.js"}"></script>
