...
class Problems extends \OmegaUp\DAO\Base\Problems {
    ...
    /**
     * @return array{alias: string, difficulty: float|null, difficulty_histogram: list<int>, points: int, quality: float|null, quality_histogram: list<int>, ratio: float, score: int, tags: array{name: string, autogenerated: bool}[], title: string, visibility: int}[]
     */
