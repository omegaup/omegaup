...
class Problems extends \OmegaUp\DAO\Base\Problems {
    ...
    /**
     * @return list<array{alias: string, difficulty: float, difficulty_histogram: list<int>, points: int, quality: float, quality_histogram: list<int>, ratio: float, score: int, tags: list<array{name: string, autogenerated: bool}>, title: string, visibility: int}>
     */
