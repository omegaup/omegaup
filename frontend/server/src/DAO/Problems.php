...
class Problems extends \OmegaUp\DAO\Base\Problems {
     ...
     * @return array{alias: string, difficulty: float|null, difficulty_histogram: list<int>, points: float, quality: float|null, quality_histogram: list<int>, ratio: float, score: float, tags: array{name: string, autogenerated: bool}[], title: string, visibility: int}[]
     */
    final public static function byIdentityType(
        ...
        /** @var list<array{points: string, ratio: string, score: string, problem_id: int, acl_id: int, visibility: int, title: string, alias: string, commit: string, current_version: string, languages: string, input_limit: int, visits: int, submissions: int, accepted: int, difficulty: int, creation_date: string, source: string, order: string, deprecated: int, email_clarifications: int, quality: null|float, quality_histogram: null|list<int>, difficulty_histogram: list<int>}> */
