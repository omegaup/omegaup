...
abstract class Problemsets {
    ...
    /**
     * Verificar si existe un {@link \OmegaUp\DAO\VO\Problemsets} por llave primaria.
     *
     * Este método verifica la existencia de un objeto {@link \OmegaUp\DAO\VO\Problemsets}
