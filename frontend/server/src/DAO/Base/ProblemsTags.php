...
abstract class ProblemsTags {
     ...
     */
    final public static function replace(\OmegaUp\DAO\VO\ProblemsTags $Problems_Tags) : int {
     ...
     */
    final public static function update(\OmegaUp\DAO\VO\ProblemsTags $Problems_Tags) : int {
        $sql = 'UPDATE `Problems_Tags` SET `public` = ?, `autogenerated` = ? WHERE `problem_id` = ? AND `tag_id` = ?;';
        $params = [
            intval($Problems_Tags->public),
            intval($Problems_Tags->autogenerated),
            is_null($Problems_Tags->problem_id) ? null : intval($Problems_Tags->problem_id),
            is_null($Problems_Tags->tag_id) ? null : intval($Problems_Tags->tag_id),
        ];
        \OmegaUp\MySQLConnection::getInstance()->Execute($sql, $params);
        return \OmegaUp\MySQLConnection::getInstance()->Affected_Rows();
    }
     ...
     *
     * Este metodo cargará un objeto {@link \OmegaUp\DAO\VO\ProblemsTags}
     ...
     * registro.
     */
    final public static function getByPK(?int $problem_id, ?int $tag_id) : ?\OmegaUp\DAO\VO\ProblemsTags {
     ...
     */
    final public static function delete(\OmegaUp\DAO\VO\ProblemsTags $Problems_Tags) : void {
    ...
    final public static function getAll(
        ...
        foreach (\OmegaUp\MySQLConnection::getInstance()->GetAll($sql) as $row) {
            $allData[] = new \OmegaUp\DAO\VO\ProblemsTags($row);
        }
        return $allData;
    }
     ...
     *
     * @param \OmegaUp\DAO\VO\ProblemsTags $Problems_Tags El
     * objeto de tipo {@link \OmegaUp\DAO\VO\ProblemsTags} a crear.
     *
     * @return int Un entero mayor o igual a cero identificando el número de filas afectadas.
     */
    final public static function create(\OmegaUp\DAO\VO\ProblemsTags $Problems_Tags) : int {
