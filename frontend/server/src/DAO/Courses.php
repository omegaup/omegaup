...
class Courses extends \OmegaUp\DAO\Base\Courses {
    ...
    public static function findByName(string $name): array {
        ...
        /** @var list<array{acl_id: int, admission_mode: string, alias: string, archived: bool, course_id: int, description: string, objective: string, finish_time: \OmegaUp\Timestamp|null, group_id: int, languages: null|string, minimum_progress_for_certificate: int|null, name: string, needs_basic_information: bool, requests_user_information: string, school_id: int|null, show_scoreboard: bool, start_time: \OmegaUp\Timestamp}> */
    ...
    final public static function getByAlias(
        ...
        /** @var array{acl_id: int, admission_mode: string, alias: string, archived: bool, course_id: int, description: string, objective: string, finish_time: \OmegaUp\Timestamp|null, group_id: int, languages: null|string, minimum_progress_for_certificate: int|null, name: string, needs_basic_information: bool, requests_user_information: string, school_id: int|null, show_scoreboard: bool, start_time: \OmegaUp\Timestamp}|null */
