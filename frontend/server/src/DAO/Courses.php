...
class Courses extends \OmegaUp\DAO\Base\Courses {
    ...
    public static function findByName(string $name): array {
        ...
        /** @var list<array{acl_id: int, alias: string, course_id: int, description: string, finish_time: null|string, group_id: int, name: string, needs_basic_information: bool, admission_mode: string, requests_user_information: string, school_id: int|null, show_scoreboard: bool, start_time: string}> */
    ...
    final public static function getByAlias(
        ...
        /** @var array{acl_id: int, alias: string, course_id: int, description: string, finish_time: null|string, group_id: int, name: string, needs_basic_information: bool, admission_mode: string, requests_user_information: string, school_id: int|null, show_scoreboard: bool, start_time: string}|null */
