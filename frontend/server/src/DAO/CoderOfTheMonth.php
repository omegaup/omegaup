...
class CoderOfTheMonth extends \OmegaUp\DAO\Base\CoderOfTheMonth {
    ...
    final public static function getByTime(string $time): array {
        ...
        /** @var list<array{coder_of_the_month_id: int, description: null|string, interview_url: null|string, rank: int, school_id: int|null, category: string|null, selected_by: int|null, time: string, user_id: int}> */
        $rs = \OmegaUp\MySQLConnection::getInstance()->GetAll($sql, [$time]);
