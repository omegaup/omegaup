 ...
 * @psalm-type RenderCallbackPayload=array{templateProperties: array{fullWidth?: bool, hideFooterAndHeader?: bool, arenaMode?: bool, payload: array<string, mixed>, scripts?: list<string>, title: \OmegaUp\TranslationString}, entrypoint: string, inContest?: bool, navbarSection?: string}
 */
class UITools {
    ...
    private static function getCommonPayload(
        ...
        return [
            ...
            'preferredLanguage' => \OmegaUp\Controllers\Identity::getPreferredLanguage(
                $identity
            ),
