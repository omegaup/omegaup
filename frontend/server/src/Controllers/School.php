 ...
 * @psalm-type SchoolRankPayload=array{page: int, length: int, rank: list<School>, totalRows: int, showHeader: bool, pagerItems: list<PageItem>, availableFilters?: array<string,string>, filter?: string}
