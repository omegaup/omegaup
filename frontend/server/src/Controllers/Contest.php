 ...
 * @psalm-type ContestIntroPayload=array{contest: ContestPublicDetails, isLoggedIn: bool, needsBasicInformation?: bool, privacyStatement?: array{markdown: string, statementType: string, gitObjectId?: string}, requestURI: string, requestsUserInformation?: string, shouldShowFirstAssociatedIdentityRunWarning?: bool}
