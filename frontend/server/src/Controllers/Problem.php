 ...
 * @psalm-type ProblemDetailsPayload=array{allowUserAddTags?: bool, hasVisitedSection: bool, hasVisitedSectionPopup: bool, allRuns?: list<Run>, totalRuns?: int, clarifications?: list<Clarification>, histogram: Histogram, levelTags?: list<string>, nominationStatus?: NominationStatus, problem: ProblemInfo, problemLevel?: null|string, publicTags?: list<string>, runs?: list<Run>, selectedPrivateTags?: list<string>, selectedPublicTags?: list<string>, solutionStatus?: string, solvers: list<BestSolvers>, user: UserInfoForProblem}
        ...
        $response = [
            'templateProperties' => [
                'payload' => [
                    ...
                    'hasVisitedSectionPopup' => \OmegaUp\UITools::hasVisitedSectionPopup(
