 ...
 * @psalm-type SubmissionFeedback=array{author: string, author_classname: string, feedback: string, date: \OmegaUp\Timestamp, range_bytes_end?: int, range_bytes_start?: int, submission_feedback_id: int, feedback_thread: list<array{author: string, authorClassname: string, text: string, timestamp: \OmegaUp\Timestamp}>}
