 ...
 * @psalm-type QualityNominationContents=array{contents: array{tag: string, quality_seal: boolean}, qualitynomination_id: int}
 * @psalm-type ProblemDetailsPayload=array{allowUserAddTags?: bool, allRuns?: list<Run>, clarifications?: list<Clarification>, histogram: Histogram, levelTags?: list<string>, nominationStatus?: NominationStatus, problem: ProblemInfo, problemLevel?: null|string, publicTags?: list<string>, runs?: list<Run>, selectedPrivateTags?: list<string>, selectedPublicTags?: list<string>, solutionStatus?: string, solvers: list<BestSolvers>, user: UserInfoForProblem, alreadyReviewedPayload?: QualityNominationContents}
...
class Problem extends \OmegaUp\Controllers\Controller {
    ...
    public static function getProblemDetailsForTypeScript(
        ...
        $alreadyReviewedPayload = null;

        if ($alreadyReviewed) {
            $alreadyReviewedPayload = ['contents' => $reviewedData['contents'], 'qualitynomination_id' => $reviewedData['qualitynomination_id']];
        }
        ...
        if ($isQualityReviewer && $alreadyReviewedPayload) {
            $response['templateProperties']['payload']['alreadyReviewedPayload'] = $alreadyReviewedPayload;
        }
    ...
    public static function getProblemEditDetailsForTypeScript(
        ...
        if ($r['request'] === 'submit') {
            ...
            $statements = json_decode($r['contents'], associative: true);
