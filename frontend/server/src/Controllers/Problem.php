...
class Problem extends \OmegaUp\Controllers\Controller {
    ...
    public static function getProblemDetails(
        ...
        // Lets the problem page hide the embedded ephemeral grader when an
        // admin has disabled it from the site settings.
    ...
    private static function buildUnloggedPayload($problem, $details): array {
        ...
        return [
            ...
            'problem' => [
                'alias' => $details['alias'],
                'ephemeralGraderEnabled' => $details['ephemeralGraderEnabled'] ?? true,
                'karel_problem' => count(
                    array_intersect(
                        $details['languages'],
                        ['kp', 'kj']
