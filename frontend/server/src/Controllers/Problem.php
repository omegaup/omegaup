 ...
 * @psalm-type ProblemDetailsv2Payload=array{nominationStatus?: NominationStatus, problem: ProblemInfo, runs?: list<Run>, solvers?: list<BestSolvers>, user: UserInfoForProblem}
