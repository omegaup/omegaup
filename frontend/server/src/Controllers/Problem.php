 ...
 * @psalm-type ProblemTagsPayload=array{alias: string, allowTags: bool, selectedTags: list<SelectedTag>, tags: list<array{name: null|string}>, publicTags: list<string>, levelTags: list<string>, title: null|string}
...
class Problem extends \OmegaUp\Controllers\Controller {
     ...
     *
     * @omegaup-request-param mixed $problemAlias
     * @omegaup-request-param mixed $levelTag
     *
     * @return array{status: string}
     */
    public static function apiUpdateProblemLevel(\OmegaUp\Request $r): array {
        ...
        $problem = \OmegaUp\DAO\Problems::getByAlias($r['problemAlias']);
        if (is_null($problem)) {
            throw new \OmegaUp\Exceptions\NotFoundException('problemNotFound');
        }
        ...
        $tag = null;
        if (!empty($r['levelTag'])) {
            $tag = \OmegaUp\DAO\Tags::getByName($r['levelTag']);
