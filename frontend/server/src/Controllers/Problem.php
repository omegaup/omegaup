 ...
 * @psalm-type ProblemVersion=array{author: Signature, commit: string, committer: Signature, message?: string, parents?: list<string>, tree: array<string, string>|null, version: string}
