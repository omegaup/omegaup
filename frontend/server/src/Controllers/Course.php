 ...
 * @psalm-type CourseTabsPayload=array{courses: array{enrolled: list<CourseCardEnrolled>, hasVisitedSection?: bool, finished: list<CourseCardFinished>, public: list<CourseCardPublic>}}
