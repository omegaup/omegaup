 ...
 * @psalm-type CourseStatisticsPayload=array{course: CourseDetails, problemStats: list<array{assignment_alias: string, problem_alias: string, variance: float|null, average: float|null, highScoreCount: int, lowScoreCount: int, minimum: float|null, maximum: float|null, maxPoints: float}>}
