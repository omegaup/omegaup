 ...
 * BadgesController
 *
 * @psalm-type NotificationContents=array{type: string, badge?: string, message?: string, status?: string, url?: string, course?: array{alias: string, name: string}, username?: string}
