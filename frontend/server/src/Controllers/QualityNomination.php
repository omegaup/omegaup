...
class QualityNomination extends \OmegaUp\Controllers\Controller {
    ...
    /**
     * @param array{tags?: list<string>, before_ac?: bool, difficulty?: int, quality?: int, statements?: array<string, array{markdown: string}>, source?: string, reason?: string, original?: string, tag?: list<string>, quality_seal?: bool} $contents
