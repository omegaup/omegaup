...
class QualityNomination extends \OmegaUp\Controllers\Controller {
    ...
    public static function apiCreate(\OmegaUp\Request $r) {
        ...
        /**
         * @var null|array{tags?: mixed, before_ac?: mixed, difficulty?: mixed, quality?: mixed, statements?: mixed, source?: mixed, reason?: mixed, original?: mixed, origine?: mixed} $contents
         */
    ...
    public static function apiDetails(\OmegaUp\Request $r) {
        ...
        /** @var null|array{status: string, nominator: array{username: string}, problem: array{alias: string}, contents: array{statements: array<string, string>}, original_contents: array{tags: array{name: string, autogenerated: bool}[]}} $response */
        $response = \OmegaUp\DAO\QualityNominations::getByID((int)$r['qualitynomination_id']);
        if (is_null($response)) {
            throw new \OmegaUp\Exceptions\NotFoundException('qualityNominationNotFound');
        }
        if (is_null($r->user)) {
