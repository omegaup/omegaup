 ...
 * @psalm-type UserListItem=array{label: string, value: string}
 * @psalm-type UserProfileDetailsPayload=array{statusError?: string, profile: UserProfileInfo, contests: UserProfileContests, solvedProblems: list<Problem>, unsolvedProblems: list<Problem>, createdProblems: list<Problem>, stats: UserProfileStats, badges: list<string>, ownedBadges: list<Badge>, programmingLanguages: array<string,string>}
 */
