 ...
 * @psalm-type UserProfileEditDetailsPayload=array{countries: list<\OmegaUp\DAO\VO\Countries>, programmingLanguages: array<string, string>, profile: UserProfileInfo, extraProfileDetails?: ExtraProfileDetails, hasPassword: bool}
...
class User extends \OmegaUp\Controllers\Controller {
    ...
    public static function getProfileEditDetailsForTypeScriptV2(\OmegaUp\Request $r) {
        ...
        $response['smartyProperties']['payload'] = [
            ...
            'hasPassword' => !is_null($r->identity->password),
        ];
        return $response;
    }
