 ...
 * @psalm-type UserProfileDetailsPayload=array{profile: UserProfileInfo, contests: UserProfileContests, solvedProblems: list<Problem>, unsolvedProblems: list<Problem>, createdProblems: list<Problem>, stats: UserProfileStats, badges: list<string>, ownedBadges: list<Badge>}
...
class User extends \OmegaUp\Controllers\Controller {
    ...
    /**
     * @return array{smartyProperties: array{STATUS_ERROR: string}|array{payload: ProfileDetailsPayload, title: string }, entrypoint: string}
     */
    public static function getProfileDetailsForSmarty(\OmegaUp\Request $r) {
        try {
            ...
            //print_r($stats);
            //print_r($profile);
            //print_r($unsolvedProblems);
            //print_r($solvedProblems);
            //print_r($createdProblems['problems']);
