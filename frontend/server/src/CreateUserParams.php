...
class CreateUserParams {
    ...
    /**
     * @param array{username?: string, name?: string, email?: string, password?: string, scholar_degree?: string, is_private?: string, gender?: string, recaptcha?: string, birthDate: string} $params
     */
