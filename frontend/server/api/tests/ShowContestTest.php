...
{    
    ...
    public function testCannotSeeNotStartedYetContest()
    {
        // Create a clean contest and get the ID
        $contestCreator = new NewContestTest();
        $contest_id = $contestCreator->testCreateValidContest(1);
        ...
        $this->fail("User was allowed to see contest not started yet.");
        var_dump($return_array);   
            
    }
       
    
    public function testAdminCannSeeNotStartedYetContest()
    {
        // Create a clean contest and get the ID
        $contestCreator = new NewContestTest();
        $contest_id = $contestCreator->testCreateValidContest(1);
        ...
        {
            var_dump($return_array);         
            $this->fail("Admin was not allowed to see contest not started yet.");            
        }
    ...
    public function testShowValidPrivateContestAsAdmin()
    {
        // Create a clean contest and get the ID
        $contestCreator = new NewContestTest();
        $contest_id = $contestCreator->testCreateValidContest(0);
