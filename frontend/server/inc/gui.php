<?php
	...
	class ClassicTheme implements Theme{
		...
		public static function getMainMenu(){
			...
			$html = "<ul >";
			$html .= "	<li><a href='probs.php'>Problemas</a></li>";
			$html .= "	<li><a href='rank.php'>Ranking</a></li>";
			$html .= "	<li><a href='recent.php'>Actividad reciente</a></li>";
			$html .= "	<li><a href='faq.php'>FAQ</a></li>";
			$html .= "	<li><a href='about.php'>About</a></li>";
			$html .= "	<li><a href='schools.php'>Escuelas</a></li>";
			$html .= "	<li><a href='profs.php'>Profesores</a></li>";			
			$html .= "	<li><a href='help.php'>Colabora</a></li>";
