...
class ProblemController extends Controller {
    ...
    public static function apiTags(Request $r) {
        ...
        Validators::isStringNonEmpty($r['problem_alias'], 'problem_alias');
        $includeAutogenerated = 0;
        if (isset($r['include_autogenerated'])) {
            Validators::isNumberInRange($r['include_autogenerated'], 'include_autogenerated', 0, 1);
            $includeAutogenerated = $r['include_autogenerated'];
        }
    ...
    public static function apiList(Request $r) {
        ...
        // Sort results
        $order = 'quality'; // Order by problem_id by default.
        $sorting_options = ['title', 'quality', 'difficulty', 'submissions', 'accepted', 'ratio', 'points', 'score'];
