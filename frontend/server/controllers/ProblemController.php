...
class ProblemController extends Controller {
    ...
    private static function validateCreateOrUpdate(Request $r, $is_update = false) {
        ...
        if ($is_update) {
            ...
            if (!Authorization::canEditProblem($r->identity, $r->user, $r['problem'])) {
                throw new ForbiddenAccessException();
            }
    ...
    public static function apiAddTag(Request $r) {
        ...
        if (!Authorization::canEditProblem($r->identity, $r->user, $problem)) {
            throw new ForbiddenAccessException();
        }
    ...
    public static function apiTags(Request $r) {
        ...
        $response['tags'] = ProblemsTagsDAO::getProblemTags(
            $problem,
            !Authorization::canEditProblem($r->identity, $r->user, $problem),
