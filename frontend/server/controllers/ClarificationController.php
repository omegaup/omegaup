...
class ClarificationController extends Controller {
	...
	private static function clarificationUpdated(Request $r, $time) {
		...
		static::broadcastClarification($r, $time);
		static::sendClarificationEmail($r, $time);
	}

	protected static function broadcastClarification(Request $r, $time) {
		try {
	...
	protected static function sendClarificationEmail(Request $r, $time) {
