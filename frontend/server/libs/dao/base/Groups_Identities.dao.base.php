...
abstract class GroupsIdentitiesDAOBase extends DAO {
     ...
     * Campos de la tabla.
     */
    const FIELDS = '`Groups_Identities`.`group_id`, `Groups_Identities`.`identity_id`, `Groups_Identities`.`share_user_information`, `Groups_Identities`.`accept_teacher`';
    ...
    final public static function getByPK($group_id, $identity_id) {
        ...
        $sql = 'SELECT `Groups_Identities`.`group_id`, `Groups_Identities`.`identity_id`, `Groups_Identities`.`share_user_information`, `Groups_Identities`.`accept_teacher` FROM Groups_Identities WHERE (group_id = ? AND identity_id = ?) LIMIT 1;';
    ...
    final public static function getAll($pagina = null, $columnas_por_pagina = null, $orden = null, $tipo_de_orden = 'ASC') {
        $sql = 'SELECT `Groups_Identities`.`group_id`, `Groups_Identities`.`identity_id`, `Groups_Identities`.`share_user_information`, `Groups_Identities`.`accept_teacher` from Groups_Identities';
        global $conn;
        if (!is_null($orden)) {
    ...
    final private static function update(GroupsIdentities $Groups_Identities) {
        $sql = 'UPDATE `Groups_Identities` SET `share_user_information` = ?, `accept_teacher` = ? WHERE `group_id` = ? AND `identity_id` = ?;';
        $params = [
    ...
    final private static function create(GroupsIdentities $Groups_Identities) {
        $sql = 'INSERT INTO Groups_Identities (`group_id`, `identity_id`, `share_user_information`, `accept_teacher`) VALUES (?, ?, ?, ?);';
        $params = [
