...
abstract class ProblemsetIdentitiesDAOBase extends DAO {
     ...
     * Campos de la tabla.
     */
    const FIELDS = '`Problemset_Identities`.`identity_id`, `Problemset_Identities`.`problemset_id`, `Problemset_Identities`.`access_time`, `Problemset_Identities`.`score`, `Problemset_Identities`.`time`, `Problemset_Identities`.`share_user_information`, `Problemset_Identities`.`accept_teacher`';
    ...
    final public static function getAll($pagina = null, $columnas_por_pagina = null, $orden = null, $tipo_de_orden = 'ASC') {
        $sql = 'SELECT `Problemset_Identities`.`identity_id`, `Problemset_Identities`.`problemset_id`, `Problemset_Identities`.`access_time`, `Problemset_Identities`.`score`, `Problemset_Identities`.`time`, `Problemset_Identities`.`share_user_information`, `Problemset_Identities`.`accept_teacher` from Problemset_Identities';
        global $conn;
        if (!is_null($orden)) {
    ...
    final public static function search($Problemset_Identities, $orderBy = null, $orden = 'ASC', $offset = 0, $rowcount = null, $likeColumns = null) {
        ...
        if (!is_null($Problemset_Identities->accept_teacher)) {
            $clauses[] = '`accept_teacher` = ?';
            $params[] = $Problemset_Identities->accept_teacher;
        }
        global $conn;
    ...
    final private static function update(ProblemsetIdentities $Problemset_Identities) {
        $sql = 'UPDATE `Problemset_Identities` SET `access_time` = ?, `score` = ?, `time` = ?, `share_user_information` = ?, `accept_teacher` = ? WHERE `identity_id` = ? AND `problemset_id` = ?;';
        $params = [
            ...
            $Problemset_Identities->accept_teacher,
    ...
    final private static function create(ProblemsetIdentities $Problemset_Identities) {
        ...
        $sql = 'INSERT INTO Problemset_Identities (`identity_id`, `problemset_id`, `access_time`, `score`, `time`, `share_user_information`, `accept_teacher`) VALUES (?, ?, ?, ?, ?, ?, ?);';
        $params = [
    ...
    final public static function byRange(ProblemsetIdentities $Problemset_IdentitiesA, ProblemsetIdentities $Problemset_IdentitiesB, $orderBy = null, $orden = 'ASC') {
        ...
        $a = $Problemset_IdentitiesA->accept_teacher;
        $b = $Problemset_IdentitiesB->accept_teacher;
        if (!is_null($a) && !is_null($b)) {
