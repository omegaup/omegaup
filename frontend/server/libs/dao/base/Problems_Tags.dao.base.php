...
abstract class ProblemsTagsDAOBase extends DAO {
     ...
     * Campos de la tabla.
     */
    const FIELDS = '`Problems_Tags`.`problem_id`, `Problems_Tags`.`tag_id`, `Problems_Tags`.`public`, `Problems_Tags`.`autogenerated`';
    ...
    final public static function search($Problems_Tags, $orderBy = null, $orden = 'ASC', $offset = 0, $rowcount = null, $likeColumns = null) {
        ...
        if (!is_null($Problems_Tags->autogenerated)) {
            $clauses[] = '`autogenerated` = ?';
            $params[] = $Problems_Tags->autogenerated;
        }
        global $conn;
    ...
    final public static function byRange(ProblemsTags $Problems_TagsA, ProblemsTags $Problems_TagsB, $orderBy = null, $orden = 'ASC') {
        ...
        $a = $Problems_TagsA->autogenerated;
        $b = $Problems_TagsB->autogenerated;
        if (!is_null($a) && !is_null($b)) {
            $clauses[] = '`autogenerated` >= ? AND `autogenerated` <= ?';
            $params[] = min($a, $b);
            $params[] = max($a, $b);
        } elseif (!is_null($a) || !is_null($b)) {
            $clauses[] = '`autogenerated` = ?';
