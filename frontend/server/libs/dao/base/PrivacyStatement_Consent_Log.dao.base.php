...
abstract class PrivacyStatementConsentLogDAOBase extends DAO {
     ...
     * Campos de la tabla.
     */
    const FIELDS = '`PrivacyStatement_Consent_Log`.`identity_id`, `PrivacyStatement_Consent_Log`.`privacystatement_id`, `PrivacyStatement_Consent_Log`.`timestamp`';
    ...
    final public static function getByPK($identity_id, $privacystatement_id) {
        ...
        $sql = 'SELECT `PrivacyStatement_Consent_Log`.`identity_id`, `PrivacyStatement_Consent_Log`.`privacystatement_id`, `PrivacyStatement_Consent_Log`.`timestamp` FROM PrivacyStatement_Consent_Log WHERE (identity_id = ? AND privacystatement_id = ?) LIMIT 1;';
    ...
    final public static function getAll($pagina = null, $columnas_por_pagina = null, $orden = null, $tipo_de_orden = 'ASC') {
        $sql = 'SELECT `PrivacyStatement_Consent_Log`.`identity_id`, `PrivacyStatement_Consent_Log`.`privacystatement_id`, `PrivacyStatement_Consent_Log`.`timestamp` from PrivacyStatement_Consent_Log';
        global $conn;
        if (!is_null($orden)) {
    ...
    final private static function update(PrivacyStatementConsentLog $PrivacyStatement_Consent_Log) {
        $sql = 'UPDATE `PrivacyStatement_Consent_Log` SET `timestamp` = ? WHERE `identity_id` = ? AND `privacystatement_id` = ?;';
        $params = [
