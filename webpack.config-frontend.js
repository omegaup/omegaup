...
module.exports = {
    ...
    entry: {
        ...
        arena_contest_practice: './frontend/www/js/omegaup/arena/contest_practice.ts',
        ...
        contest_scoreboardmerge: './frontend/www/js/omegaup/contest/scoreboardmerge.ts',
        ...
        course_submissions_list: './frontend/www/js/omegaup/course/submissions_list.ts',
        ...
        group_scoreboard_contests: './frontend/www/js/omegaup/group/scoreboard_contests.ts',
        ...
        qualitynomination_list: './frontend/www/js/omegaup/qualitynomination/list.ts',
        qualitynomination_details: './frontend/www/js/omegaup/qualitynomination/details.js',
        school_of_the_month: './frontend/www/js/omegaup/schools/schoolofthemonth.ts',
