...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    'vue-property-decorator':
      '<rootDir>/frontend/www/js/omegaup/compat-decorator.ts',
    ...
    '^bootstrap-vue$':
      '<rootDir>/frontend/www/js/omegaup/__mocks__/bootstrap-vue.ts',
  ...
  testPathIgnorePatterns: ['/node_modules/', '/frontend/www/karel.js/'],
};
